...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >            
              <tr class='seek_tr'>
                ...
                <td style="width:65%;  "><input class="txt" id="txtBindate" type="text" style="width:90px; font-size:medium;" />
                <span style="display:inline-block; vertical-align:middle">&sim;</span>
                <input class="txt" id="txtEindate" type="text" style="width:93px; font-size:medium;" /></td>
            </tr>
            <tr class='seek_tr'>
            ...
            <tr class='seek_tr'>
             ...
             <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtCarownerno" type="text" style="width:90px; font-size:medium;" />&nbsp;<input class="txt" id="txtCarowner" type="text" style="width:115px; font-size:medium;" /></td>
             </tr>
        </table>
