...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    ...
    function q_seekStr() {   
        ...
        q_sqlPara2("noa",t_noa) +q_sqlPara2("workno",t_workno) + q_sqlPara2("tggno",t_tggno) + q_sqlPara2("storeno",t_storeno);
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                ...
                <td style="width:65%;  "><input class="txt" id="txtWorkno" type="text" style="width:150px; font-size:medium;" ></td>
            </tr>
            <tr class='seek_tr'>
