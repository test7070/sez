...
<script type="text/javascript">
	...
	var aPop = new Array(['txtCustno', '', 'cust', 'noa,comp', 'txtCustno,txtComp', 'cust_b.aspx'],
						 ['txtBoatno', '', 'boat', 'noa,boat', 'txtBoatno,txtBoat', 'boat_b.aspx']);        
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("datea", t_bdate, t_edate) +
                            q_sqlPara2("custno", t_custno)+ q_sqlPara2("comp", t_comp)+q_sqlPara2("boatno", t_boatno)+ q_sqlPara2("boat", t_boat);
       ...
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
             ...
             <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtBoatno" type="text" style="width:90px; font-size:medium;" />&nbsp;<input class="txt" id="txtBoat" type="text" style="width:115px; font-size:medium;" /></td>
             </tr>
        </table>
