				...
				<div class='dbbm' style="width: 900px;float: left;">
					<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='0'>
						...
						<tr>
							...
							<td class="style2"><input id="txtAccc3" type="text" maxlength='30' style='width:97%;'/></td>
							<td class="style1" align="right"><a id='lblDmoney'> </a></td>
							<td class="style2"><input id="txtDmoney" type="text"  maxlength='30'   style='width:97%;text-align:right;'/></td>
                            <td class="tdProj" ></td>
						</tr>

						<tr>
							<td class="style1"><a id='lblWorker'> </a></td>
							<td class="style3"><input id="txtWorker"  type="text"  maxlength='20'style='width:97%; text-align:center;'/></td>
						...
						<tr>
							<td class="style1"><select id="cmbKd" class="txt c1"> </select></td>
						</tr>
					</table>
