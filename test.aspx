			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr class="tr2">
						...
						<td class="td6">
						<input type="text" id="txtInvono" class="txt c1"/>
						</td>
					</tr>
					...
					<tr class="tr4">
						...
						<td class="td5" align="right"><span> </span>
						<input type="button" id="btnAccc" />
						</td>
						<td class="td6">
					...
					<tr class="tr9">
						...
						<td class="td4"><select id="cmbTaxtype" class="txt c1"></select></td>
