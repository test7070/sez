    ...
    <head>
		...
		<script type="text/javascript">
            ...
            function q_stPost() {
                if (q_cur == 1 || q_cur == 2) {
					if (q_cur == 1){
						q_func('qtxt.query.VccToOrde', 'vcc_rb2.txt,VccToOrde,' + encodeURI(r_accy) + ';' + encodeURI($('#txtNoa').val())+ ';1;' + encodeURI('RB'));
					}
            ...
            function btnDele() {
				...
				q_func('qtxt.query.VccToOrde', 'vcc_rb2.txt,VccToOrde,' + encodeURI(r_accy) + ';' + encodeURI($('#txtNoa').val())+ ';0;' + encodeURI('RB'));
