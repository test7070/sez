<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
             var q_name = 'carbrand', t_bbsTag = 'tbbs', t_content = " field=noa,brand  order=odate ", afilter = [], bbsKey = ['noa'], as;
            //, t_where = '';
		...
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				<tr>
					...
					<th align="center" style='color:Blue;' ><a id='lblBrand'></a></th>
				</tr>
				<tr>
					<td style="width:2%;">
					...
					<td style="width:75%;">
					<input class="txt" id="txtBrand.*" type="text" style="width:98%;"  readonly="readonly" />
					</td>
				</tr>
			</table>
