...
<head>
    ...
    <script type="text/javascript">
        ...
        q_tables = 's';
        var q_name = "accc";
        var decbbs = ['accc8', 'floata', 'ver'];
        var decbbm = ['dmoney', 'cmoney', 'ver'];
        ...
        function btnPrint() {
            q_box("z_acccp.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + $('#txtAccc3').val() + ";" + r_accy + "_" + r_cno, 'z_accc1', "95%", "650px", q_getMsg('popZ_accc1'));
        }
        ...
        function bbsSave(as) {   /// 表身 寫入資料庫前，寫入需要欄位
            if (!as['accc5'] && !as['accc6'] && !dec(as['accc8'])) {  //不存檔條件
        ...
        function sum() {
            ...
            for (var j = 0; j < q_bbsCount; j++) {
                ...
                td = td + (s1 == dcType[0] ? t_accc8 : 0);
                tc = tc + (s1 == dcType[1] ? t_accc8 : 0);
            }  // j

          
            q_tr('txtDmoney', td, t_prec);
            q_tr('txtCmoney', td, t_prec);
