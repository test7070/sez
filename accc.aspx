...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            aPop = [['txtPart_', 'btnPart_', 'acpart', 'noa,part', 'txtPart_', "acpart_b.aspx?" + r_userno + ";" + r_name + ";" + q_time + "; ;" + r_accy + '_' + r_cno]
            , ['txtAccc5_', 'btnAcc_', 'acc', 'acc1,acc2', 'txtAccc5_,txtAccc6_,txtAccc7_', "acc_b.aspx?" + r_userno + ";" + r_name + ";" + q_time + "; ;" + r_accy + '_' + r_cno]
            , ['txtAccc7_', 'btnQphr_', 'qphrs', 'code,phr', 'txtAccc7_,txtAccc7_', "qPhrs.aspx?" + r_userno + ";" + r_name + ";" + q_time + "; ;" + r_accy + '_' + r_cno, 'txtAccc5_', 'noa']
            , ['txtBal_', '     ', 'acbal', 'acc1,bal,money', ' ,txtBal_, ,txtAccc8_', '', 'txtAccc5_', 'noa']];
            ...
            function q_gtPost(t_name) {/// 資料下載後 ...
                switch (t_name) {
                    ...
                    case 'acuser':
                        ...
                        ret = q_gridAddRow(bbsHtm, 'tbbs', 'txtAccc4,txtAccc5,txtPart,txtAccc6,txtAccc7,txtAccc8', as.length, as, 'accc4,accc5,part,accc6,accc7,accc8', 'txtAccc5');
				...
				<div class='dbbm' style="width: 780px;float: left;">
					<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='0'>
						<tr>
							...
							<select id="combAccc1" style='width:88%;font-size: medium;' />
							</td>
