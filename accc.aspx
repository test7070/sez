	...
	<head>
		...
		<script type="text/javascript">
		    ...
		    function _btnSeek() {
		        ...
		        q_box('accc_s.aspx', q_name + '_s', "500px", "330px", q_getMsg("popSeek"));
		    }
			...
			<div class='dbbs' id='dbbs'>
				...
				<table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
					<tr style='color:White; background:#003366;' >
						...
						<td align="center"  class="tdProj" style="width:6%;"><a id='lblProj'> </a></td>
					...
					<tr  style='background:#cad3ff;'>
						...
						<input class="txt" id="txtProj.*" type="text" maxlength='90' style="width:45%; " />
						</td>
						<td>
