	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_seekStr() {
				...
				t_driver = $('#txtDdriver').val();
				t_boatno = $('#txtBoatno').val();
				t_boat = $('#txtBoat').val();
				...
				var t_where = " 1=1 "  + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("mon", t_bmon,t_emon) + 
				q_sqlPara2("carno", t_carno) + q_sqlPara2("addr", t_addr) + q_sqlPara2("custno", t_custno)+ q_sqlPara2("comp", t_comp)
				+ q_sqlPara2("driverno", t_driverno)+ q_sqlPara2("driver", t_driver)+ q_sqlPara2("boatno", t_boatno)+ q_sqlPara2("boat", t_boat);
		...
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					...
					<td>
					<input class="txt" id="txtBoatno" type="text" style="width:90px; font-size:medium;" />
					&nbsp;
					<input class="txt" id="txtBoat" type="text" style="width:115px; font-size:medium;" />
					</td>
				</tr>
			</table>
