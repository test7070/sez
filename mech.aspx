            ...
            <div class="dview" id="dview" style="float: left;  width:32%;"  >
                ...
                <div class='dbbm' style="width: 68%;float:left">
                    <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
                        ...
                        <tr>
                            <td class="label1" ><a id="lblMech"></a></td>
                            <td class="column1"><input id="txtMech"  type="text"  class="txt c1"/></td>
                            <td class="label2" ></td>
                            <td class="column2"></td>
                            <td class="label3" ></td>
                            <td class="column3"></td>
                        ...
                        <tr>
                            <td class="label1" ><input id="btnStore" type="button" style="width: auto;font-size: medium;"/></td>
                            <td class="column1"><input id="txtStoreno"  type="text"  class="txt c1"/></td>
                            <td class="label2" colspan="2" ><input id="txtStore"  type="text"  class="txt c1"/></td>
                            <td class="label3" ></td>
                            <td class="column3"></td>
                        </tr>
                        <tr>
                            <td class="label1" ><a id="lblGen"></a></td>
                            <td class="column1"><input id="txtGen"  type="text"  class="txt c1"/></td>
