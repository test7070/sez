...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>                        
            <tr>
               ...
               <td class="label2" ><a id='lblProduct'></a></td>
               <td class="column2"><input id="txtProduct" type="text" class="txt c1" /></td>
               <td class="label3" ><a id='lblUnit'></a></td>
               <td class="column3"><input id="txtUnit"  type="text" class="txt c1" /></td>
            </tr>
            <tr>
               <td class="label1" </td>
               <td class="column1"></td>
