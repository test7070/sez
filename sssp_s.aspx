	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_seekStr() {
				...
				var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("namea", t_namea) + q_sqlPara2("partno", t_partno) + q_sqlPara2("part", t_part) + q_sqlPara2("cno", t_cno) + q_sqlPara2("comp", t_comp);
