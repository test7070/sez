...
<script type="text/javascript">
    ...
    function main() {
        mainSeek();
        q_gf('', q_name);
        q_cmbParse("cmbOuts", ('').concat(new Array( '全部','委外加工','沒有委外')));
    }
    ...
    function q_seekStr() {   
		...
		if($('#cmbOuts').val()=='委外加工')
			t_where+=" and isouts=1 ";
		if($('#cmbOuts').val()=='沒有委外')
			t_where+=" and isouts=0 ";
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                <td class='seek'  style="width:20%;"><a id='lblOuts'></a></td>
                <td><select id="cmbOuts" class="txt c1"> </select></td>
            </tr>
        </table>
