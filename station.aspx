		...
		<script type="text/javascript">
           ...
           $('#txtNoa').val($.trim($('#txtNoa').val()));   	
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)
                    return;
                q_box('station_s.aspx', q_name + '_s', "550px", "400px", q_getMsg("popSeek"));
            }
            function btnIns() {
                _btnIns();
               refreshBbm();
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
            		...
            		<tr>
               			...
               			<td class="td2" colspan="2"><input id="txtFactoryno"  type="text" class="txt c2"/>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs'>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td><input class="btn"  id="btnMechno.*" type="button" value='.' style=" font-weight: bold;width:1%;float:left;" />
						<input id="txtMechno.*" type="text" style="width: 75%;"/></td>
					<td>
                        <input type="text" id="txtMech.*" class="txt c1"/>
					</td>
