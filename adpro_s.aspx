...
<script type="text/javascript">
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("mon", t_mon) + q_sqlPara2("datea", t_bdate, t_edate) 
        + q_sqlPara2("productno", t_productno) + q_sqlPara2("product", t_product) + q_sqlPara2("tggno", t_tggno) + q_sqlPara2("comp", t_comp);
       ...
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' > 
            ...
            <tr class='seek_tr'>
             ...
             <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtProductno" type="text" style="width:215px; font-size:medium;" />
                </td>
             </tr>
             <tr class='seek_tr'>
             ...
             <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtTggno" type="text" style="width:215px; font-size:medium;" />
                </td>
             </tr>
             <tr class='seek_tr'>
