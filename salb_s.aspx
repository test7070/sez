...
<script type="text/javascript">
    var q_name = "salb_s";
	var aPop = new Array(['txtCno', 'lblAcomp', 'acomp', 'noa,acomp', 'txtCno,txtComp2', 'acomp_b.aspx']);
    ...
    function q_seekStr() {   
        ...
        + q_sqlPara2("cno", t_cno)  + q_sqlPara2("comp2", t_comp2);
       ...
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtCno" type="text" style="width:90px; font-size:medium;" />&nbsp;
                	<input class="txt" id="txtComp2" type="text" style="width:115px; font-size:medium;" /></td>
            </tr>
        </table>
