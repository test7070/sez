...
<head>
    ...
    <script type="text/javascript">
        ...
        var q_readonlys = ['txtOrdeno', 'txtNo2']; // detail 唯讀物件
        ...
        var bbsNum = [['txtPrice', 12, 3], ['txtWeight', 11, 2, 1], ['txtMount', 9, 2, 1], ['txtTotal', 15, 0, 1]]; // detail 允許 key 小數  [物件,整數位數,小數位數, comma Display]
...
>>>>>>> 7646e63c7d4e40450ccad6741b99cf7f7604594d
                ...
                if (!$('#btnMinus_' + i).hasClass('isAssign')) {
                    ...
                    $('#txtMemo_' + i).change(function (e) {
		                    ...
		                    if ($.trim($(this).val()).substring(0, 1) == '.')
		                        $('#txtTotal_' + b_seq).removeAttr('readonly');
		                    else
		                        $('#txtTotal_' + b_seq).attr('readonly', 'readonly');
		                });
                }
            } //j
            _bbsAssign();
