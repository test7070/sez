...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			q_tables = 't';
			var q_name = "tranorde";
			var q_readonly = ['txtNoa', 'txtTranquatno','txtTweight2','txtTtrannumber', 'txtTranquatnoq', 'txtWorker', 'txtWorker2'];
			var q_readonlys = [];
			var bbsNum = [];
			...
			function mainPost() {
				...
				$('#btnDeliveryno').click(function(e) {
					if ($('#cmbDeliveryno').val().length == 0) {
						alert('請輸入速配袋號!');
						return;
					}
					$(this).val('請稍後');
					t_where = "where=^^b.deliveryno='" + $('#cmbDeliveryno').val() + "'  and  (c.tranno is null or c.noa='" + $('#txtNoa').val() + "')^^";
			...
			var TranOrdetPage = 0; //目前頁數 從0開始 每頁5個; 
