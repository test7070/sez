	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_seekStr() {
				...
				var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("typea", t_typea) + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("carno", t_carno) + q_sqlPara2("driverno", t_driverno);
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a>司機編號</a></td>
					<td>
					<input class="txt" id="txtDriverno" type="text" style="width:90px; font-size:medium;" />
					</td>
				</tr>
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a>司機名稱</a></td>
					<td>
					<input class="txt" id="txtDriver" type="text" style="width:90px; font-size:medium;" />
					</td>
				</tr>
			</table>
