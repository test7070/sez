    ...
    <script type="text/javascript">
       ...
       function main() {
        ...
        function btnOk() {
            ...
            t_err = q_chkEmpField([['txtNoa', q_getMsg('lblNoa')], ['txtTeam', q_getMsg('lblTeam')] ]);
            if( t_err.length > 0) {
                alert(t_err);
                return;
            }
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <div class="dview" id="dview" style="float: left;  width:35%;"  >
           <table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
            <tr>
                ...
                <td align="center" style="width:30%"><a id='vewTeam'></a></td>
            </tr>
             <tr>
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>            
            ...
            <tr>
               ...
               <td class="td2"><input id="txtTeam"  type="text" class="txt c1"/></td>
               <td class="td3"></td>
               <td class="td4"></td>
            </tr>
        </table>
