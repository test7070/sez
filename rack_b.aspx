<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var q_name = 'rack', t_content = ' field=noa,rack,storeno,store,place', bbsKey = ['noa'], as;
			var t_sqlname = 'rack_load';
			t_postname = q_name;
			var isBott = false;
		...
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				<tr>
					...
					<th align="center" style='color:Blue;' ><a id='lblRack'></a></th>
				...
				<tr>
					...
					<td style="width:20%;"><input class="txt" id="txtRack.*" type="text" style="width:98%;"  readonly="readonly" /></td>
					<td style="width:40%;">
