...
<head>
    ...
    <script type="text/javascript">
        ...
        aPop = new Array(['txtAcc1', 'btnAcc', 'acc', 'acc1,acc2', 'txtAcc1,txtAcc2', 'acc_b.aspx'],['txtPartno', 'btnPart', 'Part', 'noa,part', 'txtPartno,txtPart', 'part_b.aspx'],['txtSssno', 'btnSss', 'sss', 'noa,namea', 'txtSssno,txtNamea', 'sss_b.aspx'],['txtChgitemno', 'btnChgitem', 'chgitem', 'noa,item', 'txtChgitemno,txtChgitem', 'chgitem_b.aspx']);
       ...
       function main() {
        ...
        function mainPost() { // ??J?????A?? refresh ?e
                ...
                <div class='dbbm' style="float: left;">
                    <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
                        ...
                        <tr>
                            ...
                            <td class="label2" ><a id="lblTime"></a></td>
                            <td class="column2"><input id="txtTime"  type="text"  class="txt c1"/></td>
                        </tr>
                        <tr>
                            <td class="label1" ><input id="btnChgitem" type="button" style="width: auto;font-size: medium;"/></td>
                            <td class="column1" ><input id="txtChgitemno"  type="text"  class="txt c1"/></td>
                            <td class="column1a"><input id="txtChgitem"  type="text"  class="txt c1"/></td>
                            <td class="label2" ><input id="btnAcc" type="button" style="width: auto;font-size: medium;"/></td>
                            <td class="column2" ><input id="txtAcc1"  type="text"  class="txt c2"/>
                            <input id="txtAcc2"  type="text"  class="txt c2"/></td>                           
                        ...
                        <tr>            
                            ...
                            <td class="column1"><input id="txtPartno"  type="text"  class="txt c1"/></td>
                            <td class="column1a"><input id="txtPart"  type="text"  class="txt c1"/></td>                                                        
                        </tr>
                        <tr>
