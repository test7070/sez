		...
		//1030726拿掉 	['txtMemo', '', 'qphr', 'code,phr', 'txtMemo,txtMemo', "qPhr_b.aspx", 'txtAcc1'],
		    ...
		    function btnOk() {
		       ...
		       if($('#cmbDc').val() == 3 && q_getPara('sys.project').toUpperCase()=='DC'){
		        	if( ($('#txtAcc1').val() == '') || ($('#txtAcc2').val() == '') || ($('#txtAcc1').val().substring(0,4) !='1101' && $('#txtAcc1').val().substring(0,4) !='1111' && $('#txtAcc1').val().substring(0,4) !='1112') ){
		    ...
		    function btnPrint() {
		        q_box('z_chgcash.aspx' + "?;;;;" + r_accy + ";noa=" + trim($('#txtNoa').val()), '', "95%", "95%", q_getMsg("popPrint"));
		    }
