...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <tr>            
          <td><input id="txtNoa" maxlength='20' type="text"  style='width:80%;'/></td>
        </tr>
        </table>
        </div>
        <div class='dbbs' > 
        <table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
            <tr style='color:White; background:#003366;' >
                ...
                <td align="center"><a id='lblStopdate'></a></td>
                <td align="center"><a id='lblEnddate'></a></td>
                <td align="center"><a id='lblChgdate'></a></td>
                <td align="center"><a id='lblOldNoa'></a></td>
