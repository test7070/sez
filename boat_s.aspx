...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = "boat_s";
            aPop = new Array(['txtNoa', '', 'boat', 'noa,boat', 'txtNoa,txtBoat', 'boat_b.aspx']);
		...
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					...
					<td>
					<input class="txt" id="txtBoat" type="text" style="width:215px; font-size:medium;" />
					</td>
				</tr>
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblConn'></a></td>
					<td>
					<input class="txt" id="txtConn" type="text" style="width:215px; font-size:medium;" />
					</td>
				</tr>
