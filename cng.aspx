...
<head>
    ...
    <script type="text/javascript">
        ...
        aPop = new Array(['txtStoreno', 'lblStore', 'store', 'noa,store', 'txtStoreno,txtStore', 'store_b.aspx'],['txtStorinno', 'lblStorein', 'store', 'noa,store', 'txtStorinno,txtStorin', 'store_b.aspx'],['txtProductno_', 'btnProductno_', 'ucc', 'noa,product', 'txtProductno_,txtProduct_', 'ucc_b.aspx']);
       ...
       // aPop = [['txtStoreno', 'btnStore', 'store', 'noa,store', 'txtStoreno,txtStore', 'store_b.aspx'],
         //       ['txtStorinno', 'btnStorin', 'store', 'noa,store', 'txtStorinno,txtStorin', 'store_b.aspx', "60%", "650px", q_getMsg('popStore')],
    ...
    <style type="text/css">
      #dmain{overflow:hidden;}
		 ...
		 .tbbm tr{height:35px;}
		 .td1{width: 11%;}
		 .td3, .td5, .td7{width: 12%;}
		 .td2, .td4, .td6, .td8{width: 15%;}
		 ...
		 .tbbm tr td .txt.c4{width:48%;float:left;}
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <tr><td class='td1'><span> </span><a id="lblType" class="lbl" ></a></td>
        	<td class="td2"><select id="cmbTypea" class="txt c2"></select></td>
        ...
        <tr>
            ...
            <td class="td2"><input id="txtStoreno" type="text"  class="txt c3"/><input id="txtStore" type="text" class="txt c4"/></td></tr>
        <tr>        
            <td class="td1"><span> </span><a id="lblStorein" class="lbl btn"></a></td>
            <td class="td2"><input id="txtStorinno" type="text" class="txt c3"/>
            	<input id="txtStorin" type="text" class="txt c4"/></td> 
        ...
        <table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
            ...
            <tr  style='background:#cad3ff;'>
                ...
                <td style="width:25%;"><input class="txt c8" id="txtProduct.*" type="text"/></td>
                <td style="width:4%;"><input class="txt c8" id="txtUnit.*" type="text" /></td>
                <td style="width:8%;"><input class="txt c7" id="txtMount.*" type="text"/></td>
