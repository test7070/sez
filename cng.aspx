...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <tr><td class='td1'><span> </span><a id="lblType" class="lbl" ></a></td>
        	<td class="td2"><select id="cmbTypea" class="txt c5"></select></td>
        ...
        <tr>
            ...
            <td class="td2"><input id="txtStoreno" type="text"  class="txt c6"/><input id="txtStore" type="text" class="txt c6"/></td></tr>
        <tr>        
            <td class="td1"><span> </span><a id="lblStorein" class="lbl btn"></a></td>
            <td class="td2"><input id="txtStorinno" type="text" class="txt c6"/>
