...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            var bbmNum = new Array(['txtBmiles', 10, 0], ['txtEmiles', 10, 0], ['txtMiles', 10, 0], ['txtRate', 10, 2], ['txtMount', 10, 3], ['txtPrice', 10, 2], ['txtMoney', 10, 0], ['txtCurmount', 10, 3], ['txtCurmoney', 10, 2]);
            ...
            function mainPost() {
                ...
                $('#cmbProduct').change(function(e){
                	if ($('#txtOilstationno').val().length > 0){
	                    ...
	                    q_gt('oilorg', "where=^^oilstationno='" + t_oilstationno + "' and product='"+t_product+"'^^", 0, 0, 0, "");
	                }
                });
            }
            ...
            function _btnSeek() {
                ...
                q_box('oil_s.aspx', q_name + '_s', "600px", "500px", q_getMsg("popSeek"));
            }
