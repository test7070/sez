		...
		var isorda=true; //選擇要產生orde還是orda 要產生orda=ture,要產生orde=false
            ...
            function q_gfPost() {
                ...
                $('#btnOrdb').click(function(){
                	if($('#chkWorkgall [type]=checkbox').prop('checked'))
                		q_gt('workg', "where=^^isnull(ordbno,'')='' and isnull(ordano,'')=''^^", 0, 0, 0, "ordb", r_accy,1);
                	else
                		q_gt('workg', "where=^^isnull(ordbno,'')='' and isnull(ordano,'')='' and noa between '"+$('#txtWorkgno1').val()+"' and '"+(emp($('#txtWorkgno2').val())?'CHAR(255)':$('#txtWorkgno2').val())+"' ^^ ", 0, 0, 0, "ordb", r_accy,1);
	           ...
	           $('#btnOrda').click(function(){
                	if($('#chkWorkgall [type]=checkbox').prop('checked'))
                		q_gt('workg', "where=^^isnull(ordbno,'')='' and isnull(ordano,'')=''^^", 0, 0, 0, "orda", r_accy,1);
                	else
                		q_gt('workg', "where=^^isnull(ordbno,'')='' and isnull(ordano,'')='' and noa between '"+$('#txtWorkgno1').val()+"' and '"+(emp($('#txtWorkgno2').val())?'CHAR(255)':$('#txtWorkgno2').val())+"' ^^ ", 0, 0, 0, "orda", r_accy,1);
	            ...
	            $('#btnOrda2ordb').click(function(){
                	q_gt('orda', "where=^^isnull(workgno,'')!='' and isnull(ordbno,'')='' and noa in (select zno from sign where enda='Y' and left(zno2,4)='orda') and noa in (select ordano from view_workg where noa between '"+$('#txtWorkgno1').val()+"' and '"+(emp($('#txtWorkgno2').val())?'CHAR(255)':$('#txtWorkgno2').val())+"') ^^ ", 0, 0, 0, "orda2ordb", r_accy,1);
					...
					if (as[0] != undefined) {
						...
						q_gt('workg', "where=^^isnull(ordbno,'')='' and  noa between '"+$('#txtWorkgno1').val()+"' and '"+(emp($('#txtWorkgno2').val())?'CHAR(255)':$('#txtWorkgno2').val())+"' ^^ ", 0, 0, 0, "orda_workg", r_accy,1);
						
						var as = _q_appendData("workg", "", true);
						if (as[0] != undefined) {
							q_gt('workg', "where=^^isnull(ordano,'')='' and  noa between '"+$('#txtWorkgno1').val()+"' and '"+(emp($('#txtWorkgno2').val())?'CHAR(255)':$('#txtWorkgno2').val())+"' ^^ ", 0, 0, 0, "orda_workg_ordano", r_accy,1);
							var as = _q_appendData("workg", "", true);
							if (as[0] != undefined) {
								alert('未產生簽核。');
							}else{
								q_gt('orda', "where=^^ordbno!='' and workgno between '"+$('#txtWorkgno1').val()+"' and '"+(emp($('#txtWorkgno2').val())?'CHAR(255)':$('#txtWorkgno2').val())+"' ^^ ", 0, 0, 0, "orda_ordbno", r_accy,1);
								var as = _q_appendData("orda", "", true);
								if (as[0] != undefined) {
									alert('已產生請購。');
								}else{
	            ...
	            $('#btnCheck').click(function(){
	            	if($('#chkWorkgall [type]=checkbox').prop('checked'))
	            		q_gt('workg', "where=^^ isnull(ordano,'')='' and isnull(ordbno,'')='' ^^", 0, 0, 0, "check", r_accy,1);
	            	else
	            		q_gt('workg', "where=^^ isnull(ordano,'')='' and isnull(ordbno,'')='' and noa between '"+$('#txtWorkgno1').val()+"' and '"+(emp($('#txtWorkgno2').val())?'CHAR(255)':$('#txtWorkgno2').val())+"'^^", 0, 0, 0, "check", r_accy,1);
