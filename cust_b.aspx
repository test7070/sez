...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'cust', t_content = ' field=noa,comp,tel,fax,zip_comp,addr_comp,zip_home,addr_home,zip_fact,addr_fact,trantype,zip_invo,addr_invo,paytype,nick,conn,conntel,serial', bbsKey = ['noa'], as;
            var isBott = false;
            /// 是否已按過 最後一頁
