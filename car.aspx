...
<!--#include file="../inc/toolbar.inc"-->
       <div id='dmain' style="overflow:hidden;">
	    ...
	    <tr>
               <td class="td1"><span> </span><a id='lblCar' class="lbl"></a></td>
               <td class="td2" colspan='3'><input id="txtCar" type="text"  class="txt c6"/></td>
               <td class="td5"></td>
	    </tr>
 	    <tr>
               <td class="td1"><span> </span><a id='lblTel' class="lbl"></a></td>
               <td class="td2"><input id="txtTel" type="text" class="txt c1"/></td>
	           <td class="td3"><span> </span><a id='lblConn' class="lbl"></a></td>
               <td class="td4"><input id="txtConn" type="text"  class="txt c1"/></td>
               <td class="td5"></td>
            </tr>
	    <tr>   
