       ...
       <div id='dmain' style="overflow:hidden;">
        <div class="dview" id="dview" style="float: left;  width:25%;"  >
           <table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
            <tr>
                ...
                <td align="center" style="width:40%"><a id='vewCar'></a></td>
            </tr>
             <tr>
                   <td ><input id="chkBrow.*" type="checkbox" style=''/> </td>
                   <td align="center" id='noa'>~noa</td>
                   <td align="center" id='car'>~car</td>
            </tr>
        </table>
        </div>
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
            <tr>
               ...
               <td class="column1"><input id="txtNoa" maxlength='8'type="text"  style='width:100%; '/></td>
	    </tr>
	    <tr>
               <td class="label1" align="right" ><a id='lblCar'></a></td>
               <td class="column1" colspan='5'><input id="txtCar" maxlength='20' type="text"  style='width:100%;'/></td>
	    </tr>
 	    <tr>
		...
		<td class="label1" align="right" ><a id='lblAddr'></a></td>
               <td class="column1" colspan='5'><input id="txtAddr" maxlength='40' type="text"  style='width:100%;'/></td>
	   </tr>        
        </table>
        </div>
       </div>
