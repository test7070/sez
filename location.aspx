...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
        	...
        	{
        		telephone = prompt('請輸入手機號碼') ;
        		if(emp(telephone)||telephone==null){
        			mapins=true;
        		}
        		else{
            		location.href = location.href + "?;;;noa='"+telephone+"'";
            	}
        	}
        ...
        function check_telephone() {
            if(!emp(trim($('#txtNoa').val()))){
            	...
            	telephone = prompt('請輸入手機號碼') ;
            	if(!emp(trim(telephone))){
            		mapins=true;
            		$('#txtNoa').val(telephone);
            		initialize();
            	}
            }
        }
		...
		function getLocation(){
		   if(navigator.geolocation){
			  ...
			  navigator.geolocation.getCurrentPosition(getGps, errorHandler,options);
			  btnModi();
		   }else{
