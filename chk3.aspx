        ...
        <script type="text/javascript">
            ...
            function mainPost() {
                ...
                $('#btnGqb').click(function() {
                    t_where = "where=^^(len(isnull(a.tbankno,''))=0 and len(isnull(a.usage,''))=0 and isnull(a.enda,'')!='Y' and a.typea='1' and isnull(b.sel,0)=0) or (c.noa is not null and c.noa='"+$.trim($('#txtNoa').val())+"') ^^";
                    Lock();
            ...
            function btnPrint() {
                q_box('z_chk3p.aspx'+ "?;;;;" + r_accy+ ";noa=" + trim($('#txtNoa').val()), '', "95%", "95%", q_getMsg("popPrint"));
            }
