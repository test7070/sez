		...
		<script type="text/javascript">
            ...
            function q_gtPost(t_name) {
            	switch (t_name) {
            		case 'carbrand':
						...
						q_cmbParse("cmbBrand", t_item);
						$("#cmbBrand").val(abbm[q_recno].carbrandno);
						break;
             		case 'carspec':
						...
						$("#cmbSpec").val(abbm[q_recno].carspecno);
						break;
            ...
            function _btnSeek() {
                if(q_cur > 0 && q_cur < 4)// 1-3
                    return;
            	//q_box('carstyle_s.aspx', q_name + '_s', "500px", "310px", q_getMsg( "popSeek"));
            }
	...
	<body>
			...
			<div class="dview" id="dview" >
				<table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
					<tr>
						...
						<td align="center" style="width:90%"><a id='vewNoa'></a></td>
					</tr>
					<tr>
			...
			<div class='dbbm' style="float:left">
				<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='0'>
					<tr class="tr1">
						<td class="td1" style="width:20%"><span> </span><a id="lblNoa" class="lbl"></a></td>
						<td class="td2" style="width:80%"><input id="txtNoa" type="text" class="txt c4"/></td>
					</tr>
					<tr class="tr2">
						<td class="td1"><span> </span><a id="lblBrand" class="lbl"></a></td>
						<td class="td2"><select id="cmbBrand" style="width:95%;"></td>
					</tr>
					<tr class="tr3">
						<td class="td1"><span> </span><a id="lblTon" class="lbl"></a></td>
						<td class="td2"><input id="txtTon" type="text" class="txt c1"/>	</td>
					</tr>
					<tr class="tr4">
						<td class="td1"><span> </span><a id="lblSpec" class="lbl"></a></td>
						<td class="td2"><select id="cmbSpec" style="width:95%;"></td>
					</tr>
					<tr class="tr5">
