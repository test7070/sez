...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
			q_desc = 1;
            var q_name = "traneprice2";
            var q_readonly = ['txtNoa', 'txtWorker', 'txtWorker2'];
            var bbmNum = [['txtDiscount', 10, 2, 1]];
            var bbmMask = [];
            q_sqlCount = 6;
            brwCount = 6;
            brwList = [];
            ...
            function _btnSeek() {
                ...
                q_box('traneprice2_s.aspx', q_name + '_s', "500px", "310px", q_getMsg("popSeek"));
            }
			...
			function q_stPost() {
                ...
                //修改資料
                var t_noa = $.trim($('#txtNoa').val());
                q_func('qtxt.query.edit_discount', 'traneprice.txt,edit_discount,' + r_name + ';' + t_noa);
            }
		...
		<div id='dmain' >
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width:80px; color:black;"><a>製單日期</a></td>
						<td align="center" style="width:80px; color:black;"><a>司機</a></td>
						<td align="center" style="width:60px; color:black;"><a>車牌</a></td>
						<td align="center" style="width:60px; color:black;"><a>折扣</a></td>
					</tr>
					<tr>
						<td> <input id="chkBrow.*" type="checkbox" /> </td>
						<td id="datea" style="text-align: center;">~datea</td>
						<td id="driverno" style="text-align: center;">~driverno</td>
						<td id="carno" style="text-align: right;">~carno</td>
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						<td><span> </span><a id='lblTranno' class="lbl">出車單號</a></td>
						<td><input id="txtTranno"  type="text"  class="txt c1"/></td>
					</tr>
					<tr>
						<td><span> </span><a id='lblDate' class="lbl">登錄日期</a></td>
						<td colspan="3">
					...
					<tr>
						...
						<td colspan="3">
							<input id="txtBtrandate" type="text" style="float:left;width:40%;"/>
							<a style="float:left;width:5%;"> ~ </a>
							<input id="txtEtrandate" type="text" style="float:left;width:40%;"/>
						</td>
					</tr>
					<tr>
						<td><span> </span><a id="lblDriver" class="lbl" >司機</a></td>
						<td><input id="txtDriverno" type="text" class="txt c1"/></td>
					</tr>
					<tr>
