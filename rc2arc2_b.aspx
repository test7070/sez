...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'rc2arc2', t_bbsTag = 'tbbs', t_content = "", afilter = [], bbsKey = ['noa'], as;
            //, t_where = '';
            var t_sqlname = 'rc2arc2';
            t_postname = q_name;
            brwCount = -1;
			brwCount2 = 0;
			q_bbsFit = 1;
            ...
            function bbsAssign() {
                ...
                for(var j = 0; j < (q_bbsCount == 0 ? 1 : q_bbsCount); j++) {    
                	$('#lblNo_' + j).text(j + 1);
                    $('#chkSel_'+j).prop('checked',$('#txtRc2ano_'+j).val().length>0);
		...
		<div id="dbbs">
			<table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:white; background:#003366;' >
					...
					<td class="td3" align="center" style="width:80px;"><a id='lblNoa'>進貨單號</a></td>
					<td class="td3" align="center" style="width:40px;"><a id='lblNoq'>序</a></td>
					<td class="td3" align="center" style="width:80px;"><a id='lblUno'>批號</a></td>
					<td class="td3" align="center" style="width:80px;"><a id='lblProductno'>品號</a></td>
				...
				<tr  style='background:#cad3ff;'>
					<td>
						...
						<input type="text" id="txtRc2ano.*" class="txt" style="display:none;"/>
					</td>
					...
					<td><input type="text" id="txtUno.*" class="txt" style="width:95%;"/></td>
					<td><input type="text" id="txtProductno.*" class="txt" style="width:95%;"/></td>
