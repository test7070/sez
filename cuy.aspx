...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			q_tables = 's';
			var q_name = "cuy";
			var q_readonly = ['txtNoa','txtStation','txtDatea','txtStationgno','txtStationg','txtWorker','txtWorker2'];
			...
			function mainPost() {
				...
				$('#btn_div_copy').click(function() {
					...
					q_func('qtxt.query.cuycopy', 'cuy.txt,cuycopy,'+t_copy_noa+';'+t_copy_bdate+';'+t_copy_edate+';'+t_copy_saturday+';'+t_copy_sunday+';'+t_week+';'+r_name);
					$('#div_copyweek').hide();
				});
