			...
			<div class='dbbm' style="width: 73%;float: left;">
				<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
					<tr class="tr1">
						...
						<td class="td6">
						<input id="txtKeyin"  type="text"  class="txt c2"/>
					...
					<tr class="tr2">
						...
						<td class="td3">
						<input id="btnDetail" type="button"/>
						</td>
					...
					<tr class="tr4">
						...
						<input id="txtTel" type="text" class="txt c6"/>
						</td>
					</tr>
					<tr class="tr5">
					...
					<tr class="tr6">
						...
						<td class="td4">
						<input id="txtConntel" type="text" class="txt c1"/>
						</td>
						<td class="td5"><span> </span><a id='lblConnfax' class="lbl"></a></td>
						<td class="td6">
						<input id="txtConnfax" type="text" class="txt c1"/>
						</td>
					</tr>
					<tr class="tr7">
					...
					<tr class="tr8">
						...
						<input id="txtAddr_fact"  type="text" class="txt c6"/>
						</td>
					</tr>
					<tr class="tr9">
						...
						<td  class="td3" colspan='4' >
						<input id="txtAddr_comp"  type="text" class="txt c6"/>
						</td>
					</tr>
					<tr class="tr10">
						...
						<td  class="td3" colspan='4' >
						<input id="txtAddr_invo"  type="text" class="txt c6" />
						</td>
					</tr>
					<tr class="tr11">
						...
						<td  class="td3" colspan='4' >
						<input id="txtAddr_home"  type="text" class="txt c6"/>
						</td>
					</tr>
					<tr class="tr12">
						<td class="td1" ><a class="lbl">E-mail</a></td>
						<td class="td2" colspan='5' >
						<input id="txtEmail" class="txt c6"/>
						</td>
					</tr>
					<tr class="tr13">
						<td class="td1"><span> </span><a id="lblCredit" class="lbl btn"></a></td>
						<td class="td2">
						<input id="txtCredit" type="text" class="txt num c1" />
						</td>
						...
						<td class="td6">
						<input id="txtGrpno" type="text" class="txt c2"/>
						<input id="txtGrpname"    type="text" class="txt c3"/>
						</td>
					</tr>
					<tr class="tr14">
						<td class="td1"><span> </span><a id="lblInvest" class="lbl btn"></a></td>
						<td class="td2" colspan='5' >
						<input id="txtInvestdate"  type="text" class="txt c4"/>
						<input id="txtInvestmemo"  type="text" class="txt c5"/>
						</td>
					...
					<tr class="tr15">
						...
						<td class="td2" colspan='3' >
						<input id="txtChkstatus"  type="text" class="txt c6"/>
						</td>
					...
					<tr class="tr16">
						...
						<td class="td4">
						<input id="txtStartn" type="text" class="txt num c1" />
						</td>
					...
					<tr class="tr18">
						...
						<select id="combPaytype" class="txt c2" onchange='combPaytype_chg()' ></select></td>
					...
					<tr class="tr19">
						...
						<td class="td2" colspan="5">
						<input id="txtBillmemo" type="text" class="txt c6"/>
						</td>
					</tr>
					<tr class="tr20">
						<td class="td1"><span> </span><a id='lblInvomemo' class="lbl"></a></td>
						<td class="td2" colspan="5">
						<input id="txtInvomemo" type="text" class="txt c6"/>
						</td>
					</tr>
					<tr class="tr21">
						<td class="td1"><span> </span><a id='lblIntroducer' class="lbl"></a></td>
						<td class="td2">
						<input id="txtIntroducer" type="text" class="txt c1"/>
						</td>
						<td class="td3"><span> </span><a id='lblBillday' class="lbl"></a></td>
						<td class="td4" colspan="3">
						<input id="txtBillday" type="text" class="txt c1">
						</td>
					</tr>
					<!-- <tr class="tr21">
					...
					<tr class="tr22">
						...
						<td class="td2">
						<input id="txtTax1" type="text" class="txt num c1"/>
						</td>
						...
						<td class="td6">
						<input id="txtTax3" type="text" class="txt num c1"/>
						</td>
					</tr>
					<tr class="tr23">
						<td class="td1"><span> </span><a id='lblTaxrate' class="lbl"></a></td>
						<td class="td2">
						<input id="txtTaxrate" type="text" class="txt num c1"/>
						</td>
					</tr>
					<tr class="tr24">
