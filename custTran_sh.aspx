            ...
            function mainPost() {
              ...
              /*  $("#cmbBillday").focus(function() {
               ...
               /* $('#lblCredit').click(function(){
                ...
                $('#btnCont').click(function(e) {         //行車里程Button
                            t_where = "custno='" + $('#txtNoa').val() + "'";
                            q_box("contdc_sh.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + t_where, 'contdc', "95%", "95%", q_getMsg('btnCont'));
                });
            ...
            <div class='dbbm'>
                <table class="tbbm"  id="tbbm">
                    ...
                    <tr>
                        ...
                        <td><span> </span><a id='lblType_sh' class="lbl">租倉型態</a></td>
                        <td><select id="cmbTypea"  class="txt c1"> </select></td>
                        <td>
                            <input id="btnCont" type="button" value="坪數合約" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <!--<tr>
                        ...
                        <td class="trX"><input id="txtPprice"  type="text" class="txt num c1"/></td>
                        <td class="trX"><span> </span><a id='lblTprice' class="lbl">噸單價</a></td>
                        <td class="trX"><input id="txtTprice" type="text" class="txt num c1"/></td>
                        <td class="tdZ trX"> </td>
                    </tr>
                    <tr>
                        <td class="trX"><span> </span><a id='lblSqprice' class="lbl">坪單價</a></td>
                        <td class="trX"><input id="txtSqprice" type="text" class="txt num c1"/></td>
                        <td class="trX"><span> </span><a id='lblStprice' class="lbl">推高機費</a></td>
                        <td class="trX"><input id="txtStprice" type="text" class="txt num c1"/></td>
