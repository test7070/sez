...
<div  id="dbbs"  >
        <table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:690px'  >
            <tr style='color:White; background:#003366;' >
                ...
                <td align="center" style="width:18%;"><a id='lblNamea'></a></td>
            ...
            <tr  style='background:#cad3ff;'>
                <td style="width:12%;"><input class="txt" id="txtSssno.*" type="text" maxlength='90' style="font-size:medium;width:96%;"   /></td>
                <td style="width:18%;"><input class="txt"  id="txtNamea.*" maxlength='30'type="text" style="font-size:medium;width:96%;" /></td>
                ...
                <td style="width:10%;text-align:center;"><input id="chkPrice_show.*" type="checkbox"/></td>
                <td style="width:10%;text-align:center;"><input id="chkPrice_modi.*" type="checkbox"/>
...
<div  id="dbbtail" style=" text-align:right" >
                <p></p>
                <a id='lblPrice'> </a><input class="txt" id="textPrice" type="text" style="width:25%;" />
                <a id='lblMemo'> </a><input class="txt"  id="textMemo" type="text" style="width:25%;" />
</div>
