    ...
    <script type="text/javascript">
       ...
       function main() {
        ...
        function _btnSeek() {
            ...
            q_box('carreason_s.aspx', q_name + '_s', "500px", "340px", q_getMsg( "popSeek"));
        }
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>            
            ...
            <tr>
               ...
               <td class="td2" colspan="2"><textarea id="txtReason" cols="10" rows="5" style="width: 98%;height: 50px;"></textarea></td>
               <td class="td4"></td>
            </tr>
        </table>
        </div>
