...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            brwNowPage = 0;
            brwKey = 'Odate';
            aPop = new Array(['txtProductno1_', 'btnProduct1_', 'bcc', 'noa,product,unit', 'txtProductno1_,txtProduct_,txtUnit_', 'bcc_b.aspx'], ['txtProductno2_', 'btnProduct2_', 'ucaucc', 'noa,product,unit', 'txtProductno2_,txtProduct_,txtUnit_', 'ucaucc_b.aspx'], ['txtProductno3_', 'btnProduct3_', 'fixucc', 'noa,namea,unit', 'txtProductno3_,txtProduct_,txtUnit_', 'fixucc_b.aspx'], ['txtSalesno', 'lblSales', 'sss', 'noa,namea', 'txtSalesno,txtSales', 'sss_b.aspx'], ['txtCno', 'lblAcomp', 'acomp', 'noa,acomp,addr', 'txtCno,txtAcomp,txtAddr2', 'acomp_b.aspx'], ['txtTggno', 'lblTgg', 'tgg', 'noa,comp,paytype', 'txtTggno,txtTgg,txtPaytype', 'tgg_b.aspx']);
            ...
            function mainPost() {
                ...
                /*$('#lblLcno').click(function () {
                 var t_lcno = trim($('#txtLcno').val());
                 var t_where = "1=1";
                 if(t_lcno.length>0)
                 t_where+=" and lcno='"+t_lcno+"'";
                 q_box("lcs.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + t_where, 'lcs', "95%", "650px", q_getMsg('popLcs'));
                 });*/
            }
            ...
            function btnPrint() {
                q_box('z_ordcp.aspx?;;;;' + r_accy, '', "95%", "95%", q_getMsg("popPrint"));
            }
			...
			<div class='dbbm' >
				<table class="tbbm"  id="tbbm" style="width: 872px;">
					...
					<tr class="tr5">
						...
						<td class="td3" colspan='4' ><input id="txtAddr"  type="text"  class="txt c1 lef" style="width: 98%;"/></td>
					...
					<tr class="tr6">
						...
						<td class="td4">
						<input id="txtTax"  type="text" class="txt num c1 lef" />
						</td>
		...
		<div class='dbbs' >
			<table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
				...
				<tr  style='background:#cad3ff;'>
					...
					<!--<td><input id="txtDime.*" type="text"  class="txt num c6"/>x
