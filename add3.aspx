	...
	<head>
		...
		<script type="text/javascript">
			...
			currentData.prototype = {
				...
				/*新增時複製的欄位*/
				//bbm
				include : ['cmbTypea','txtCardealno','txtCardeal','cmbCartype','txtBoil','txtEoil'],
				//bbs
				includes : ['txtPostno_', 'txtPost_','txtPrice2_','txtPrice_','txtCount1_','txtCount2_','txtMemo_'],
				/*記錄當前的資料*/
				copy : function() {
					this.data = new Array();
					for (var i in fbbm) {
			...
			function mainPost() {
				...
				bbsNum = [['txtPrice2', 10, q_getPara('vcc.pricePrecision'), 1],['txtPrice', 10, q_getPara('vcc.pricePrecision'), 1],
								['txtCount1', 10, q_getPara('vcc.mountPrecision'), 1],['txtCount2', 10, q_getPara('vcc.mountPrecision'), 1]]
			...
			function q_gtPost(t_name) {
				switch (t_name) {
					case 'carspec':
                        ...
                        q_cmbParse("cmbCartype", t_item);
                        if(abbm[q_recno])
                        	$("#cmbCartype").val(abbm[q_recno].cartype);
                        break;
					case q_name:
						if (q_cur == 4)
							q_Seek_gtPost();
				...
				<table class="tbbm" id="tbbm">
					...
					<tr>
						...
						<td class="td6">
							...
							<select id="cmbCartype" class="txt c1"> </select>
						</td>
					</tr>
					<tr>
