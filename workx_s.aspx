...
<script type="text/javascript">
    var q_name = "workx_s";
		aPop = new Array(['txtStationno', '', 'station', 'noa,station', 'txtStationno', 'station_b.aspx']);
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("datea", t_bdate, t_edate)+ q_sqlPara2("trandatea", t_btrandate, t_etrandate) 
        + q_sqlPara2("noa", t_noa) + q_sqlPara2("workno", t_workno) + q_sqlPara2("stationno", t_stationno) + q_sqlPara2("station", t_station);
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                <td  style="width:35%;" ><a id='lblTrandatea'></a></td>
            ...
            <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtStationno" type="text" style="width:90px; font-size:medium;" />&nbsp;
                	<input class="txt" id="txtStation" type="text" style="width:115px; font-size:medium;" /></td>
            </tr>
        </table>
