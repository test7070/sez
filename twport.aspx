		...
		<script type="text/javascript">
            ...
            function btnOk() {
                ...
                if (t_noa.length == 0 || t_noa == "AUTO")
                    q_gtnoa(q_name, replaceAll(q_getPara('sys.key_twport') + (t_date.length == 0 ? q_date() : t_date), '/', ''));
                else
                    wrServer(t_noa);
            }
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)
                    return;
                q_box('twport_s.aspx', q_name + '_s', "600px", "450px", q_getMsg("popSeek"));
            }
            ...
            function btnPrint() {
                q_box('z_twportp.aspx' + "?;;;;" + r_accy + ";noa=" + trim($('#txtNoa').val()), '', "95%", "95%", q_getMsg("popPrint"));
            }
