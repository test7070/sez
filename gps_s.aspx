...
<script type="text/javascript">
    var q_name = "gps_s";
	var aPop = new Array(['txtCarno', '', 'car2', 'a.noa,driverno,driver', 'txtCarno', 'car2_b.aspx']);
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("datea", t_bdate, t_edate) +
                            q_sqlPara2("carno", t_carno)+ q_sqlPara2("miles", t_miles) ;
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtMiles" type="text" style="width:215px; font-size:medium;" /></td>
             </tr>
        </table>
