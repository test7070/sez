...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            var bbmNum = [['txtWeight', 10, 3, 1],['txtVolume', 10, 3, 1]];
            var bbmMask = [];
            q_sqlCount = 6;
            brwCount = 6;
            brwList = [];
            ...
            q_xchg = 1;
            brwCount2 = 15;
            aPop = new Array(['txtCno', 'btnCno', 'acomp', 'noa,acomp', 'txtCno,txtAcomp', 'acomp_b.aspx']
            , ['txtCustno', 'btnCust', 'cust', 'noa,nick', 'txtCustno,txtCust', 'cust_b.aspx']
            , ['txtProductno', 'btnProduct', 'ucc', 'noa,product', 'txtProductno,txtProduct', 'ucc_b.aspx']
            , ['txtCarno', 'btnCarno', 'car2', 'a.noa,driverno,driver', 'txtCarno,txtDriverno,txtDriver', 'car2_b.aspx']
            , ['txtAddrno', 'btnStraddr', 'addr', 'noa,addr', 'txtAddrno,txtAddr', 'addr_b.aspx']
            );
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)
                    return;
                q_box('tranvcces_ay_s.aspx', q_name + '_s', "500px", "600px", q_getMsg("popSeek"));
            }
