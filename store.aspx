...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>            
            ...
            <tr>
               <td class="label1" ><a id='lblStore'></a></td>
               <td class="column1"><input id="txtStore"  type="text" class="txt c1"/></td>
               <td class="label2" ></td>
               <td class="column2"></td>
            
            </tr>
            <tr>
               <td class="label1" ><a id='lblStart'></a></td>
               <td class="column1"><input id="txtStart"  type="text" class="txt c1" /></td>
               <td class="label2" ></td>
               <td class="column2"></td>
            </tr>
            <tr>
               <td class="label1" ><input id="btnTgg" type="button" style="width: auto;font-size: medium;" /></td>
               <td class="column1"><input id="txtTggno"  type="text" style="width: 30%;"/><input id="txtTgg"  type="text" style="width: 61%;"/></td>
               <td class="label2" ></td>
               <td class="column2"></td>
            </tr>    
        </table>
