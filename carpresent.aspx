            ...
            switch (t_name) {
                ...
                case q_name: 
                	 if(insimport){
						...
						t_where=t_where+"and a.carno not in (select carno from trans101 where carno in(select noa from car2 where cartype='2') and datea='"+t_date+"' group by carno) and a.driverno!=''^^";
