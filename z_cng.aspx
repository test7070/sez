		...
		<script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#q_report').click(function() {
                    ...
                    if ((q_getPara('sys.comp').indexOf('英特瑞') > -1 || q_getPara('sys.comp').indexOf('安美得') > -1) && $('#q_report').data().info.reportData[$('#q_report').data().info.radioIndex].report == 'z_cng2') {
                        $('#txtMon1').val('');
                        $('#txtMon2').val('');
                        $('#Mon').hide();
                        $('#Date').show();
                    ...
                    if (q_getPara('sys.project').toUpperCase() != 'RB') {
                        ...
                        for (var i = 0; i < $('#q_report').data().info.reportData.length; i++) {
                            if ($('#q_report').data().info.reportData[i].report == 'z_cng6')
                                delete_report = i;
                        }
                        if ($('#q_report div div').text().indexOf('客戶借出未還統計表') > -1)
