    ...
    <script type="text/javascript">
       ...
       function main() {
        ...
        function _btnSeek() {
            ...
            q_box('custchg_s.aspx', q_name + '_s', "500px", "330px", q_getMsg( "popSeek"));
        }
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
          <tr>
            ...
            <tr>
               ...
               <td class="td2"><input id="txtCaritemno"  type="text"  class="txt c2"/>
            ...
            <tr>
               ...
               <td class="td2"><input id="txtCaritemno2"  type="text" class="txt c2"/>
