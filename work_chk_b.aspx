<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		...
		var q_name = 'view_work' , t_content = ' field=noa,style,kdate,workdate,uindate,cuadate,ordeno,no2,enddate,mount,rmount,inmount,wmount,memo,productno,product,process,station,processno,stationno,unit,modelno,model,hours,tggno,comp,cuano,cuanoq', bbsKey = ['noa'], as, t_where = '';
		var t_sqlname = 'view_work_load'; t_postname = q_name;
