...
<script type="text/javascript">
    var q_name = "chk2_s";
    aPop = new Array(['txtBankno', '', 'bank', 'noa,bank', 'txtBankno,txtBank', 'bank_b.aspx']); 
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("bank", t_bank)+ q_sqlPara2("bankno", t_bankno)+ q_sqlPara2("worker", t_worker)
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
             ...
             <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtBankno" type="text" style="width:90px; font-size:medium;" />&nbsp;
