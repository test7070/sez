...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <tr>
            ...
            <td class="column1"><input id="txtStationno" type="text" class="txt c2"/><input id="txtStation" type="text" class="txt c2"/></td>
        ...
        <td class="column1" colspan='5'><input id="txtMemo" type="text"  style="width: 99%;"/></td></tr>
        </table>
        </div>
