...
<script type="text/javascript">
    var q_name = 'acpart', t_content = ' field=noa,part', bbsKey = ['noa'], as;
    ...
    var i,s1;
        ...
        function q_gtPost(q_name) {  /// 資料下載後 ...
...
<div  id="dbbs"  >
       <table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
            ...
            <tr>
                ...
                <td style="width:75%;"><input class="txt" id="txtPart.*" type="text" style="width:98%;"  readonly="readonly" /></td>
            </tr>
        </table>
