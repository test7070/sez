...
<script type="text/javascript">
    var q_name = "labpay_s";
	aPop = new Array(['txtAcc1', '', 'acc', 'acc1,acc2', 'txtAcc1', "acc_b.aspx?" + r_userno + ";" + r_name + ";" + q_time + "; ;" + r_accy+ '_' + r_cno]);
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("noa", t_noa) + q_sqlPara2("acc1", t_acc1);
