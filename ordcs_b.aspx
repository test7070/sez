...
<script type="text/javascript">
    var q_name = 'ordcs', t_bbsTag = 'tbbs', t_content = " field=productno,product,unit,mount,weight,noa,no2,price,total,memo  order=odate ", afilter = [], bbsKey = ['noa', 'no2'], t_count = 0, as;
