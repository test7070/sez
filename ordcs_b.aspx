...
<script type="text/javascript">
    var q_name = 'ordcs', t_bbsTag = 'tbbs', t_content = " field=productno,product,size,dime,width,lengthb,unit,mount,weight,notv,noa,no2,price  order=odate ", afilter = [], bbsKey = ['noa', 'no2'], t_count = 0, as;
