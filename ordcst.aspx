...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			var q_readonlys = ['txtC1','txtNotv','txtNo2'];
			...
			['txtTggno','lblTgg','tgg','noa,comp,paytype,tel,fax,addr_fact,zip_fact','txtTggno,txtTgg,txtPaytype,txtTel,txtFax,txtAddr,txtPost','tgg_b.aspx']);
			...
			function q_boxClose(s2) {///   q_boxClose 2/4
				...
				switch (b_pop) {
					...
					if (q_cur > 0 && q_cur < 4) {
						...
						ret = q_gridAddRow(bbsHtm, 'tbbs', 'txtProductno,txtProduct,txtSpec,txtDime,txtWidth,txtLengthb,txtRadius,txtOrdbno,txtNo3,txtPrice,txtMount,txtWeight,txtTotal,txtMemo,txtTheory,txtStyle,txtClass,txtUno,txtSize', b_ret.length, b_ret
															, 'productno,product,spec,dime,width,lengthb,radius,noa,no3,price,mount,weight,total,memo,theory,style,class,uno,size'
			...
			function btnPrint() {
				q_box('z_ordcstp.aspx?;;;', '', "95%", "95%", q_getMsg("popPrint"));
			}
