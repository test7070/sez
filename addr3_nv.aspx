...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
			...
			brwCount2 = 6;
			aPop = new Array(
            ['txtNoa', 'lblNoa', 'tgg', 'noa,comp', 'txtNoa,txtNamea', 'tgg_b.aspx']
        ...
        <div id='dmain' >
            <div class="dview" id="dview">
                <table class="tview" id="tview">
                    <tr>
                        ...
                        <td align="center" style="width:100px; color:black;"><a id='vewNoa_pa'>廠商編號</a></td>
                        <td align="center" style="width:150px; color:black;"><a id='vewNamea_pa'>廠商</a></td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class='dbbm'>
                <table class="tbbm"  id="tbbm">
                    ...
                    <tr></tr>
                    <tr>
                        <td><span> </span><a id="lblNoa" class="lbl btn">廠商</a></td>
                        <td colspan="3">
                            <input id="txtNoa" type="text" class="txt c1" style="width: 30%"/>
        ...
        <div class='dbbs'>
            <table id="tbbs" class='tbbs'>
                <tr style='color:white; background:#003366;' >
                    ...
                    <td align="center" style="width:100px;">生效日期</td>
                    <td align="center" style="width:150px;">品名</td>
                    <td align="center" style="width:80px;">成本單價</td>
                ...
                <tr  style='background:#cad3ff;'>
                    ...
                    <td><input type="text" id="txtAddr2.*" class="txt c1" style="width: 98%"/></td>
                    <td><input type="text" id="txtProductno.*" class="txt c1" style="width: 35%"/>
                        <input type="text" id="txtProduct.*" class="txt c1" style="width: 60%"></td> 
                    <td><input type="text" id="txtPrice1.*" class="txt c1 num" style="width: 98%"/></td>
                    <td><input type="text" id="txtMemo.*" class="txt c1" style="width: 98%"/></td>
                </tr>
            </table>
        </div>
