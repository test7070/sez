	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                var t_where = " 1=1 " + q_sqlPara2("noa", t_noa)+ q_sqlPara_or(["bdate","edate"], t_datea) 
                +q_sqlPara_or(["binvono","einvono"], t_invono) + q_sqlPara2("acomp", t_acomp) + q_sqlPara2("cno", t_cno);
