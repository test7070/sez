			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td class="td2">
						<input id="txtInpaymemo"  type="text" class="txt c5"/>
						</td>
					</tr>
					<tr>
						<td class="td1"><span> </span><a id='lblIncome' class="lbl"> </a></td>
						<td class="td2">
						<input id="txtIncome"  type="text" class="txt num c1"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="td2">
						<input id="txtMemo"  type="text" class="txt c5"/>
						</td>
					</tr>
				</table>
			</div>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs'>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td>
					<input id="txtIncome.*" type="text" style="width: 95%;text-align: right;"/>
					</td>
					<td>
					<input id="txtPay.*" type="text" style="width: 95%;text-align: right;"/>
					</td>
				</tr>
			</table>
		</div>
