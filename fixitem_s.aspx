...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                <td class='seek'  style="width:20%;"><a id='lblMile'></a></td>
                <td><input class="txt" id="txtMile" type="text" style="width:215px; font-size:medium;" /></td>
            </tr>
        </table>
