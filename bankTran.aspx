		...
		<script type="text/javascript">
			...
			function refresh(recno) {
				...
				if (abbm[q_recno] != undefined)
					q_modiDate = abbm[q_recno]['datea'];
				/// 若未指定， d4=  abbm[q_recno]['datea'];
			}
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<span style="float:left; display:block; width:10px;"> </span><span style="float:left; display:block; width:30px;">~</span>
