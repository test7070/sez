...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
            ...
            ,['txtPretime', 12, 2, 1],['txtBadperc', 15, 5, 1, 1],['txtUweight', 15, 3, 1],['txtMakes', 15, 2, 1],['txtPacks', 15, 2, 1],['txtWages', 15, 2, 1],['txtSafemount', 15, 2, 1],['txtStdmount', 15, 2, 1]];/*,['txtMechs', 15, 2, 1],['txtTrans', 15, 2, 1]*/
            var bbsNum = [['txtMount', 15, 5, 1, 1]/*, ['txtWeight', 11, 2]*/, ['txtHours', 9, 2,1],['txtLoss', 15, 5, 1, 1],['txtDividea', 10, 0, 1],['txtMul', 10, 2, 1]];
            var bbtNum = [['txtMount', 15, 5, 1, 1]/*, ['txtWeight_', 12, 2 ,1]*/,['txtPrice', 15, 5, 1, 1], ['txtEndmount', 12, 0, 1], ['txtEndweight', 15, 3, 1]
            ...
            aPop = new Array(
				...
				//107/05/24 增加皮料1-4
                ,['txtGroupjno','lblGroupjno','adly','noa,mon,memo1,memo2','0txtGroupjno,textGroupjmon,textGroupjmemo1,textGroupjmemo2','']
            ...
            function mainPost() {
                q_getFormat();
                bbmMask = [['txtKdate', r_picd], ['txtWdate', r_picd], ['txtBdate', r_picd], ['txtEdate', r_picd], ['txtIssuedate', r_picd]];
                q_mask(bbmMask);
            ...
            function btnOk() {
                ...
                if (s1.length == 0 || s1 == "AUTO")
                    q_gtnoa(q_name, replaceAll('D' + $('#txtKdate').val(), '/', ''));
                else
                    wrServer(s1);
            }
            function _btnSeek() {
            ...
            function refresh(recno) {
                ...
                //讀取貿易件號 106/09/22
                if(!emp($('#txtNoa').val())){
                    var t_where = "where=^^ (ucano='"+$('#txtNoa').val()+"' or uccno='"+$('#txtNoa').val()+"') ^^";
                    q_gt('ucx', t_where, 0, 0, 0, "",r_accy,1);
                    var as = _q_appendData("ucx", "", true);
                    if (as[0] != undefined) {
                        $('#textUcxno').val(as[0].noa);
                    }else{
                        $('#textUcxno').val('');
                    }
                }
        ...
        <div id='dmain' style="overflow:hidden; width: 1260px;">
            ...
            <div class='dbbm' style="width: 850px;float: left;">
                <table class="tbbm" id="tbbm" border="0" cellpadding='2' cellspacing='0' >
                    ...
                    <!--107/05/24 再度開放皮料1~4 -->
                    <tr>
                        <td><span> </span><a id="lblGroupjno" class="lbl" style="text-align: right;">皮料1<br>Da1</a></td>
                        <td>
                    ...
                    <tr>
                        <td><span> </span><a id="lblGroupkno" class="lbl" style="text-align: right;">皮料2<br>Da2</a></td>
                        <td>
                    ...
                    <tr>
                        <td><span> </span><a id="lblGrouplno" class="lbl" style="text-align: right;">皮料3<br>Da3</a></td>
                        <td>
                    ...
                    <tr>
                        <td><span> </span><a id="lblGroupmno" class="lbl" style="text-align: right;">皮料4<br>Da4</a></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <!--<td><input id="btnUcam" type="button" /></td>-->
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="txtHminutes" type="text" class="txt num c1" style="width: 30%;" />
                            <span style="float:left;width:15%;padding-left:3px;">Min.</span>
                            <input id="txtHsec" type="text" class="txt num c1" style="width: 30%;" />
                            <span style="float:left;width:15%;padding-left:3px;">Sec.</span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td><span> </span><a id="lblPacks" class="lbl"> </a></td>
                    ...
                    <tr>
                        <td><span> </span><a id="lblUcxno" class="lbl">貿易件號</a></td>
                        <td><input id="textUcxno" type="text" class="txt c1"/></td>
                        <td><span> </span><a id="lblBdate" class="lbl">有效日期</a></td>
                        <td><input id="txtBdate" type="text" class="txt c1" style="width: 45%;"/>
                            <a style="float: left;">~</a>
                            <input id="txtEdate" type="text" class="txt c1" style="width: 45%;"/>
                        </td>
                        <td><span> </span><a id="lblIssuedate" class="lbl">發行日期</a></td>
                        <td>
                            <input id="txtIssuedate" type="text" class="txt c1" style="width: 65%;"/>
