	...
	<head>
		...
		<script type="text/javascript">
				...
				$('#txtNoa').change(function(e){
					...
					if($(this).val().length>0){
						if((/^(\w+|\w+\u002D\w+)$/g).test($(this).val())){
                    		...
                    		q_gt('bank2', t_where, 0, 0, 0, "checkBank2_change", r_accy);
						}else{
							Lock();
            ...
            function q_gtPost(t_name) {
                switch (t_name) {
             		case 'checkBank2no_change':
                		var as = _q_appendData("bank2", "", true);
                        if (as[0] != undefined){
                        	alert('已存在 '+as[0].noa+' '+as[0].bank2);
                        }
                 		break;
                    case 'checkBank2no_btnOk':
                		var as = _q_appendData("bank2", "", true);
                        if (as[0] != undefined){
                        	alert('已存在 '+as[0].noa+' '+as[0].bank2);
                            Unlock();
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('bank2_s.aspx', q_name + '_s', "500px", "400px", q_getMsg("popSeek"));
            }
            function btnIns() {
                _btnIns();
                refreshBbm();
            ...
            function btnOk() {
				...
				if(q_cur==1){
                    ...
                    q_gt('bank2', t_where, 0, 0, 0, "checkBank2no_btnOk", r_accy);
                }else{
                	wrServer($('#txtNoa').val());
                }
			...
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width:280px; color:black;"><a id='vewBank2'> </a></td>
					</tr>
					<tr>
						<td ><input id="chkBrow.*" type="checkbox" style=' '/></td>
						<td id='noa' style="text-align: center;">~noa</td>
						<td id='bank2' style="text-align: left;">~bank2</td>
					</tr>
				</table>
			</div>
			<div class='dbbm'>
