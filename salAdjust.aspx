...
<div  id="dbbs"  >
        <table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:1500px;'  >
            <tr style='color:White; background:#003366;' >
                ...
                <td align="center" class="td3"><a id='lblBo_duty'></a></td>
                <td align="center" class="td3"><a id='lblBo_full'></a></td>
                <td align="center" class="td3"><a id='lblBo_over'></a></td>
            ...
            <tr  style='background:#cad3ff;'>
                ...
                <td ><input class="txt c1" id="txtBo_duty.*" type="text" /></td>
                <td ><input class="txt c1" id="txtBo_full.*" type="text" /></td>
                <td ><input class="txt c1" id="txtBo_over.*" type="text" /></td>
