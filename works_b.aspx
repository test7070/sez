<html xmlns="http://www.w3.org/1999/xhtml">
	...
	var q_name = 'works', t_bbsTag = 'tbbs', t_content = " field=noa,noq,productno,product,process,processno,unit,cuadate,mount,gmount,emount,istd,tproductno,tproduct,memo ", afilter = [], bbsKey = ['noa'],  as; //, t_where = '';
...
<div id="dbbs">
		<table id="tbbs" class='tbbs' border="2" cellpadding='2' cellspacing='1' style='width:100%'>
			...
			<tr style='background:#cad3ff;'>
				...
				<td>
					<input class="txt" id="txtTproductno.*" type="text" style="width:98%;" />
