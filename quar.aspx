	...
	<head>
		...
		<script type="text/javascript">
			...
			function mainPost() {
				...
				,['txtTotalus', 15, 2, 1]];//,['txtProfit', 10, 2, 1],['txtInsurance', 10, 2, 1],['txtCommission', 10, 2, 1]
			...
			function _btnSeek() {
				...
				q_box('quar_s.aspx', q_name + '_s', "500px", "420px", q_getMsg("popSeek"));
			}
			...
			<div class='dbbm'>
				<table class="tbbm" id="tbbm" style="width: 872px;">
					...
					<tr>
						...
						<td class="totalus"><span> </span><a id='lblTotalus' class="lbl"> </a></td>
						<td class="totalus"><input id="txtTotalus"	type="text" class="txt c1 num"/></td>
					</tr>
					<tr>
