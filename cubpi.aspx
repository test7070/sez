					...
					if (!$('#btnMinut__' + i).hasClass('isAssign')) {
						$('#textSize1__' + i).change(function () {
							...
							if($('#cmbTypea').find("option:selected").text()=='製管'){
								q_tr('txtDime__'+b_seq ,q_float('textSize1__'+b_seq));//厚度$('#txtDime_'+b_seq).val($('#textSize1_' + b_seq).val());
							}else{
								q_tr('txtRadius__'+b_seq ,q_float('textSize1__'+b_seq));//短徑$('#txtRadius_'+b_seq).val($('#textSize1_' + b_seq).val());	
							}
						});
						$('#textSize2__' + i).change(function () {
							...
							b_seq = t_IdSeq;
							if($('#cmbTypea').find("option:selected").text()=='製管'){
								q_tr('txtWidth__'+b_seq ,q_float('textSize2__'+b_seq));//寬度$('#txtWidth_'+b_seq).val($('#textSize2_' + b_seq).val());	
							}else{
								q_tr('txtWidth__'+b_seq ,q_float('textSize2__'+b_seq));//長徑$('#txtWidth_'+b_seq).val($('#textSize2_' + b_seq).val());	
							}
						});
						$('#textSize3__' + i).change(function () {
							...
							b_seq = t_IdSeq;
							if($('#cmbTypea').find("option:selected").text()=='製管'){
								q_tr('txtLengthb__'+b_seq ,q_float('textSize3__'+b_seq));//長度$('#txtLengthb_'+b_seq).val($('#textSize3_' + b_seq).val());	
							}else{
								q_tr('txtDime__'+b_seq ,q_float('textSize3__'+b_seq));//厚度$('#txtDime_'+b_seq).val($('#textSize3_' + b_seq).val());		
							}
						});
						$('#textSize4__' + i).change(function () {
							...
							b_seq = t_IdSeq;
							if($('#cmbTypea').find("option:selected").text()=='製管'){
								q_tr('txtRadius__'+b_seq ,q_float('textSize4__'+b_seq));//短徑為0 $('#txtRadius_'+b_seq).val($('#textSize4_' + b_seq).val());	
							}else{
								q_tr('txtLengthb__'+b_seq ,q_float('textSize4__'+b_seq));//長度$('#txtLengthb_'+b_seq).val($('#textSize4_' + b_seq).val());	
							}
						});
					}
				}
			...
			<div class='dbbs'>
				<table id="tbbs" class='tbbs'>
					...
					<tr  style='background:#cad3ff;'>
						...
						<td><input id="txtBstkweight.*" type="text" class="txt c1 num"/></td>
		...
		<div id="dbbt" class='dbbt'>
			<table id="tbbt" class="tbbt">
					<tr class="head" style="color:white; background:#003366;">
						...
						<td style="width:20px;"> </td>
						<td style="width:180px; text-align: center;">原料批號</td>
