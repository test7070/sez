    ...
    <script type="text/javascript">
        ...
        function currentData() {}
			currentData.prototype = {
				...
				/*新增時複製的欄位*/
				//bbm
				include : ['txtCarspecno','txtCarspec','txtTaxrate','txtDatea'],
				//bbs
        ...
        function mainPost() { 
            ...
            $('#txtTaxrate').change(function () {
            	for (var j = 0; j < q_bbsCount; j++) {
            		if(!emp($('#txtPtax_'+j).val())){
							q_tr('txtPtax_'+j,Math.round(dec($('#txtPtax_'+b_seq).val())*(dec($('#txtTaxrate').val())/100+1)));
					}
            	}
            });
        }
        ...
        function bbsAssign() {  ///
        	for (var j = 0; j < q_bbsCount; j++) {
        		if (!$('#btnMinus_' + j).hasClass('isAssign')) {
        			...
        			$('#txtPtax_'+j).change(function () {
        				 t_IdSeq = -1;  /// 要先給  才能使用 q_bodyId()
		                 q_bodyId($(this).attr('id'));
		                 b_seq = t_IdSeq;
        				if(!emp($('#txtTaxrate').val())){
							q_tr('txtPtax_'+b_seq,Math.round(dec($('#txtPtax_'+b_seq).val())*(dec($('#txtTaxrate').val())/100+1)));
						}
        			});
				}
            }
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <tr class="tr2">
            ...
            <td class="td4"><input id="txtTaxrate" type="text" class="txt num c1" /></td>
        ...
        <tr class="tr2">
            ...
            <td class="td2" colspan="3">
                                                     附註1：小客貨兩用車之稅額按自用小客車之稅額課徵<BR>
                                             附註2：曳引車之稅額按貨車之稅額加徵 30%
            </td>
        </tr>                                             
        </table>
        </div>
