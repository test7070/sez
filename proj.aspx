    ...
    <script type="text/javascript">
       ...
       function main() {
        	...
        	$('#txtNoa').change(function(e){
					...
					if($(this).val().length>0){
						//if((/^(\w+|\w+\u002D\w+)$/g).test($(this).val())){
                    		...
                    		q_gt('proj', t_where, 0, 0, 0, "checkProjno_change", r_accy);
						/*}else{
							Lock();
        ...
        function q_gtPost(t_name) {  
            switch (t_name) {
               case 'checkProjno_change':
                		var as = _q_appendData("proj", "", true);
                        if (as[0] != undefined){
                        	alert('已存在 '+as[0].noa+' '+as[0].proj);
                        }
                		break;
                case 'checkProjno_btnOk':
                		var as = _q_appendData("proj", "", true);
                        if (as[0] != undefined){
                        	alert('已存在 '+as[0].noa+' '+as[0].proj);
                            Unlock();
        ...
        function _btnSeek() {
            if (q_cur > 0 && q_cur < 4)  // 1-3
                return;
            q_box('proj_s.aspx', q_name + '_s', "500px", "300px", q_getMsg( "popSeek"));
        }
        function btnIns() {
            _btnIns();
            refreshBbm();
        ...
        function btnOk() {
           ...
           $('#txtNoa').val($.trim($('#txtNoa').val()));   	
			...
			if(q_cur==1){
                    ...
                    q_gt('proj', t_where, 0, 0, 0, "checkProjno_btnOk", r_accy);
                }else{
                	wrServer($('#txtNoa').val());
                }
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <div class="dview" id="dview" style="float: left;  width:35%;"  >
           <table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
            <tr>
                ...
                <td align="center" style="width:30%"><a id='vewProj'> </a></td>
            </tr>
             <tr>
                   <td ><input id="chkBrow.*" type="checkbox" style=''/> </td>
                   <td align="center" id='noa'>~noa</td>
                   <td align="center" id='proj'>~proj</td>
            </tr>
        </table>
        </div>
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>            
            ...
            <tr>
               <td class="td1"><span> </span><a id='lblProj' class="lbl"> </a></td>
               <td class="td2"><input id="txtProj"  type="text" class="txt c1"/></td>
               <td class="td3"> </td>
               <td class="td4"> </td>
            </tr>
            <tr>
