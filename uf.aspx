...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
			...
			brwNowPage = 0;
			brwKey = 'Datea';
			aPop = new Array(['txtBankno_', 'btnBankno_', 'bank', 'noa,bank', 'txtBankno_,txtBank_', 'bank_b.aspx'], ['txtBankno', 'lblBank', 'bank', 'noa,bank,account', 'txtBankno,txtBank,txtAccount', 'bank_b.aspx']);
			...
			function q_gtPost(t_name) {
				switch (t_name) {
					case 'uf_gqb':
						...
						q_gridAddRow(bbsHtm, 'tbbs', 'chkSel,txtCheckno,txtBankno,txtBank,txtDatea,txtMoney,txtTaccl', as.length, as, 'sel,gqbno,bankno,bank,indate,money,accl', '');
