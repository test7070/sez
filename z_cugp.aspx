				...
				$.fn.barChart01 = function(value) {
					$(this).data('info', {
						...
						refresh : function(obj) {
							...
							var tmpPath = "";
							var bkColor = ['rgb(210,233,255)', 'rgb(255,238,221)'];
							//背景色
							var bkN = 1;
							//分幾個製程
							var s_process = dec(s_data.detail.length) > 8 ? 7 : dec(s_data.detail.length);
							//每個製程要區分段落
							var s_height = 80;
							//固定製程高度
				...
				$.fn.barChart02 = function(value) {
					$(this).data('info', {
						...
						refresh : function(obj) {
							...
							//排產編號(標頭)
							tmpPath += '<text font-size="22" text-anchor="start" x="' + (bkOrigin[0]) + '" y="' + 30 + '" fill="black">' + '排產編號：' + t_data.workgno + '-' + t_data.workgnoq + '&nbsp;&nbsp;&nbsp;&nbsp;製品編號：' + t_data.productno + '&nbsp;&nbsp;&nbsp;&nbsp;製品名稱：' + t_data.product + '</text>';
