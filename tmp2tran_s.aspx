            ...
            function q_seekStr() {
		        ...
		        + q_sqlPara2("datea", t_bdate, t_edate) 
				 if(t_custno.length>0)
					t_where += " and exists(select noa from tmp2trans where tmp2trans.noa=tmp2tran.noa and tmp2trans.custno='"+t_custno+"')";
                if(t_carno.length>0)
					t_where += " and exists(select noa from tmp2trans where tmp2trans.noa=tmp2tran.noa and tmp2trans.carno='"+t_carno+"')";
