	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                if(t_sssno.length>0)
                	t_where = t_where+" and exists(select * from salpresents where sssno='"+t_sssno+"' and salpresent.noa=noa )"
					...
					<td style="width:65%;  ">
					 ...
					 <tr class='seek_tr'>
		                ...
		                <td><input class="txt" id="txtSssno" type="text" style="width:90px; font-size:medium;" />&nbsp;
		                	<input class="txt" id="txtNamea" type="text" style="width:115px; font-size:medium;" disabled="disabled" />
		                </td>
		            </tr>
				</tr>
			</table>
