...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
	     ...
	     <tr>
               <td class="label1" ><a id='lblStation'></a></td>
               <td class="column1"><input id="txtStation" type="text" class="txt c1"/></td>
               <td class="label2" ></td>
               <td class="column2"></td>
        </tr>
         <tr>
	   ...
	   <tr>   
             ...
             <td class="column1" ><input id="txtWorker"  type="text" class="txt c1"/></td>
	         <td class="label2" ></td>
             <td class="column2"></td>
	   </tr>        
        </table>
