...
<script type="text/javascript">
    ...
    function q_seekStr() {   
        ...
        t_sname = $('#txtSname').val();
		t_partno = $('#txtPartno').val();
		t_part = $('#txtPart').val();
        t_bdate = t_bdate.length > 0 && t_bdate.indexOf("_") > -1 ? t_bdate.substr(0, t_bdate.indexOf("_")) : t_bdate;  /// 100.  .
        t_edate = t_edate.length > 0 && t_edate.indexOf("_") > -1 ? t_edate.substr(0, t_edate.indexOf("_")) : t_edate;  /// 100.  .

        var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) +q_sqlPara2("sname", t_sname)+ q_sqlPara2("datea", t_bdate, t_edate)+q_sqlPara2("partno", t_partno)+q_sqlPara2("part", t_part);
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >            
            ...
            <tr class='seek_tr'>
             ...
             <tr class='seek_tr'>
                <td class='seek'  style="width:20%;"><a id='lblSname'></a></td>
                <td><input class="txt" id="txtSname" type="text" style="width:215px; font-size:medium;" /></td>
            </tr>
             <tr class='seek_tr'>
