...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtTeam" type="text" style="width:215px; font-size:medium;" /></td>
            </tr>
            <tr class='seek_tr'>
            ...
            <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtAdprono" type="text" style="width:215px; font-size:medium;" /></td>
            </tr>
        </table>
