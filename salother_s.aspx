...
<script type="text/javascript">
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("mon", t_bmon,t_emon) + q_sqlPara2("noa", t_noa) + q_sqlPara2("person", t_person);
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
            ...
            <tr class='seek_tr'>
                <td class='seek'  style="width:20%;"><a id='lblPerson'> </a></td>
                <td><input class="txt" id="txtPerson" type="text" style="width:215px; font-size:medium;" /></td>
            </tr>
        </table>
