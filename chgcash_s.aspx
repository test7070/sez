...
<script type="text/javascript">
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("datea", t_bdate, t_edate)+q_sqlPara2("partno", t_partno)+q_sqlPara2("part", t_part)+q_sqlPara2("sssno", t_sssno)+q_sqlPara2("namea", t_namea);
       ...
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >            
            ...
            <tr class='seek_tr'>
             ...
             <tr class='seek_tr'>
                ...
                <td><input class="txt" id="txtSssno" type="text" style="width:90px; font-size:medium;" />&nbsp;<input class="txt" id="txtNamea" type="text" style="width:115px; font-size:medium;" /></td>
             </tr>
        </table>
