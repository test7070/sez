...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
		    ...
		    function mainPost() {
		        ...
		        $('#btnVcc').click(function (e) {
		            if (q_cur == 1 || q_cur == 2) {
		                ...
		                //		                for (var i = 0; i < q_bbsCount; i++) {
		                //		                    if ($.trim($('#txtVccno_' + i).val()).length > 0) {
		                //		                        t_where = t_where + (j==0 ? "":" or " )+" noa='" + $('#txtVccno_' + i).val() + "'";
		                //		                        t_where1 = t_where1 + (j == 0 ? "" : " or ") + " vccno='" + $('#txtVccno_' + i).val() + "'";
		                //		                        j++;
		                //		                    }
		                //		                }
		                //		                t_where = t_where + "^^";
		    ...
		    function btnPrint() {
		        q_box("z_umm.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + $('#txtNoa').val() + ";" + r_accy + "_" + r_cno, 'umm', "95%", "650px", m_print);
		    }
