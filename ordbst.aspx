...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			brwKey = 'Odate';
			q_desc = 1;
			aPop = new Array(['txtProductno_', 'btnProduct_', 'ucc', 'noa,product', 'txtProductno_,txtProduct_', 'ucc_b.aspx'], ['txtSalesno', 'lblSales', 'sss', 'noa,namea', 'txtSalesno,txtSales', 'sss_b.aspx'], ['txtCno', 'lblAcomp', 'acomp', 'noa,acomp', 'txtCno,txtAcomp', 'acomp_b.aspx'],
			...
			<div class='dbbm' >
				<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='0'>
					...
					<tr class="tr3">
						...
						<td class="td5"  colspan='2'><select id="cmbPaytype" class="txt c1" ></select>
						<input id="txtPay" type="hidden" class="txt c1"/>
						</td>
					...
					<tr class="tr5">
						...
						<td class="td8">
						<input id="txtApv" type="text" class="txt c1" disabled="disable"/>
						</td>
					</tr>
					<tr class="tr6">
		...
		<div class='dbbs' >
			<table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
				...
				<tr  style='background:#cad3ff;'>
					...
					<td>
					<input class="txt c9" id="txtStyle.*" type="text" />
					</td>
					<td>
