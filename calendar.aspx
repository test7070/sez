		...
		<script type="text/javascript">
            ...
            Calendar.prototype = {
                ...
                init : function() {
                    ...
                    $('#btnSave_msg').click(function(e) {
                        ...
                        var t_data = {
                            ...
                            isholiday : $('#chkIsholiday_msg').prop('checked')
                        };
                        var t_noa = $.trim($('#txtDate_msg').html());
                        var t_memo = $.trim($('#txtHoliday_msg').val());
                        var t_memo2 = JSON.stringify(t_data);
                        //.replace(/\"/g,'char(34)');
                ...
                getData : function() {
                    ...
                    q_func('qtxt.query.getcalendar', 'calendar.txt,getcalendar,' + encodeURI(t_year + "/" + t_month));
                },
                refresh : function() {
                ...
                case 'qtxt.query.getcalendar':
                    ...
                    if (as[0] != undefined) {
                        for (var i = 0; i < as.length; i++) {
                            t_memo = {};
                            if (as[i].memo != undefined && as[i].memo.length > 0)
                                t_memo = JSON.parse(as[i].memo);
                            t_memo.noa = as[i].noa;
                            t_memo.holiday = as[i].holiday;
                            calendar.data.push(t_memo);
                        }
                    }
                    //西元年
                    ...
                    x_month = x_month.substring(x_month.length - 2, x_month.length);
                    q_func('qtxt.query.getlunarcalendar', 'calendar.txt,getlunarcalendar,' + x_year + '/' + x_month);
                    break;
                case 'qtxt.query.getlunarcalendar':
            ...
            function q_gfPost() {
                ...
                $('#btnAuthority').css('display', '').css('z-index', '99999').offset({
                    top : 10,
                    left : 50
                });
	...
	>
		<div style="display:block;height:50px;width:50px;">
			...
			<div style="display:none;">
				...
				<div class="prt" style="margin-left: -40px;"></div>
			</div>
		</div>
		...
		<div id="calendar" align="center" style="min-width: 800px;">
			<div style="width:100%;height:50px;">
				<div id="btnPrevious" style="padding-top:10px; font-size: 35px;width:10%;height:100%;background-color:#A9E2F3;float:left;">
					◄
				</div>
				<div style="padding-top:10px; font-size: 35px; width:80%;height:100%;color:black;background-color:pink;float:left;">
					...
					<div align="center" style="width:5%;height:100%;float:left;">
						年
					</div>
				...
				<div id="btnNext" style="padding-top:10px; font-size: 35px;width:10%;height:100%;background-color:#A9E2F3;float:right;">
					►
				</div>
			</div>
			<div style="width:100%;">
		...
		<div id="msg">
			<table>
				...
				<tr>
					...
					<td>
					<input id="chkIsholiday_msg" type="checkbox" style="width:98%;"/>
					</td>
				</tr>
				<tr>
					<td><a id="lblHoliday">工作名稱</a></td>
					<td>
					<input id="txtHoliday_msg" type="text" style="width:98%;"/>
					</td>
				</tr>
				<tr>
					<td><a id="lblColor">顏　　色</a></td>
					<td>
					<input type="color" id="txtColor_msg" style="width:98%;">
					</td>
				</tr>
				<tr style="height:60px;">
					<td><a id="lblMemo">註記事項</a></td>
					<td>					<textarea id="txtMemo_msg" style="width:98%;" rows=3> </textarea></td>
				</tr>
				<tr>
					<td align="center">
					<input type="button" id="btnSave_msg" value="儲存">
					</td>
					<td align="center">
					<input type="button" id="btnClose_msg" value="關閉">
					</td>
				</tr>
			</table>
		</div>
		<div style="font-family: 'Times New Roman','標楷體';font-size: 20px;">
			※點擊滑鼠右鍵，編輯內容。
		</div>
	</body>
</html>