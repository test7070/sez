		...
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				<tr class='seek_tr'>
					...
					<td>
					<input class="txt" id="txtSerial" type="text" style="width:200px; font-size:medium;" />
					</td>
				</tr>
				...
				<tr class='seek_tr'>
					...
					<td>
					<input class="txt" id="txtBuyer" type="text" style="width:200px; font-size:medium;" />
					</td>
				</tr>
			</table>
