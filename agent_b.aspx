<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'agent', t_content = 'field=noa,Agent', bbsKey = ['noa'], as;
            var isBott = false;
            /// 是否已按過 最後一頁
            ...
            function main() {
                ...
                $('#btnSearch').click(function() {
					...
					if(!emp($('#txtAgent').val())){
						t_where+=" and charindex('"+$('#txtAgent').val()+"',Agent)>0";
					}
		...
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				<tr>
					...
					<th align="center" style='color:Blue;' ><a id='lblAgent'> </a></th>
				...
				<tr>
					...
					<td style="width:60%;"><input class="txt" id="txtAgent.*" type="text" style="width:98%;"  readonly="readonly" /></td>
			...
			<div>
				...
				<a>經銷商名稱</a>
				 <input class="txt" id="txtAgent" type="text" style="width:200px;" />
				 <BR>
				 <a>統一編號</a>
