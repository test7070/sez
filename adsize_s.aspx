...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var q_name = "adsize_s";
			aPop = new Array(
				['txtProductno', 'lblProductno', 'ucaucc', 'noa,product', 'txtProductno', "ucaucc_b.aspx"]
			);
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek" border="1" cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek' style="width:20%;"><a id='lblPstyle'> </a></td>
					<td><input class="txt" id="txtPstyle" type="text"/></td>
				</tr>
				<tr class='seek_tr'>
