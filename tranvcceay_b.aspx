<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'tranvcce', t_bbsTag = 'tbbs', t_content = " ", afilter = [], bbsKey = ['noa'], as;
            var t_sqlname = '';
            t_postname = q_name;
            var isBott = false;
		...
		<div  id="dbbs"  >
			<table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;' >
					...
					<th align="center"><a id=''>收件司機</a></th>
                    <th align="center"><a id=''>送件司機</a></th>
				</tr>
				<tr  style='background:#cad3ff;'>
                    ...
                    <td style="width:80px;">
                        <input id="txtNo2.*" type="text" style="float:left;width:95%;" readonly="readonly" />
                    </td>
                    ...
                    <td style="width:90px;"><input id="txtVolume.*" type="text" style="text-align:right;width:95%;" readonly="readonly"/></td>
                    <td style="width:90px;"><input id="txtWeight.*" type="text" style="text-align:right;width:95%;" readonly="readonly"/></td>
                    <td style="width:80px;"><input id="txtLat.*" type="text" style="float:left;width:95%;" readonly="readonly"/></td>
                    <td style="width:80px;"><input id="txtEndlat.*" type="text" style="float:left;width:95%;" readonly="readonly"/></td>
				</tr>
			</table>
		</div>
		<div>
