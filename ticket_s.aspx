...
<script type="text/javascript">
    ...
    function q_seekStr() {   
        ...
        var t_where = " 1=1 " + q_sqlPara2("ticketno", t_ticketno)+ q_sqlPara2("driver", t_driver)+ q_sqlPara2("driverno", t_driverno)
        + q_sqlPara2("carno", t_carno)+ q_sqlPara2("datea", t_bdate, t_edate);
...
<div style='width:400px; text-align:center;padding:15px;' >
       <table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
       	...
       	<tr class='seek_tr'>
                <td class='seek'  style="width:20%;"><a id='lblTicketno'></a></td>
                <td><input class="txt" id="txtTicketno" type="text" style="width:215px; font-size:medium;" /></td>
            </tr>
            <tr class='seek_tr'>
