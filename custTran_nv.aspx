...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            var bbmMask = [['txtStartdate','999/99/99']];
            q_sqlCount = 6;
            brwCount = 6;
            brwList = [];
            brwNowPage = 0;
            ...
            function mainPost() {
            	q_cmbParse("cmbTypea",'上班時間@上班時間,指定時間@指定時間,24小時皆可@24小時皆可');
                q_cmbParse("combPaytype", q_getPara('vcc.paytype'));
                q_cmbParse("cmbTrantype",'噸@噸,米@米,趟@趟');
                q_cmbParse("combSalesno2",'50T@50T,100T@100T,150T@150T,200T@200T,300T@300T');
                q_cmbParse("cmbCustno2",'含稅@含稅,未稅@未稅');
                ...
                $('#btnConn').click(function() {
                 ...
                 $('#combSalesno2').change(function() {
							if(q_cur==1 || q_cur==2)
								$('#txtSalesno2').val($('#combSalesno2').find(":selected").text()); 
                				$('#combSalesno2')[0].selectedIndex=0;
				});
            }
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<!--<td><input id="btnDetail" type="button" style="float:left; width:50px; height:25px;"/></td>-->
					...
					<tr>
						...
						<td><span> </span><a id='' class="lbl">可送貨時間</a></td>
						<td><select id="cmbTypea"  class="txt c1"> </select></td>
						
					</tr>
					<tr>
						<td><span> </span><a id='' class="lbl">縣市</a></td>
						<td><input id="txtCountry" type="text" class="txt c1"/></td>
						<td><span> </span><a id='' class="lbl">地點代號</a></td>
						<td><input id="txtSales2" type="text" class="txt c1"/></td>
						<td><span> </span><a id='' class="lbl">桶槽容量</a></td>
						<td>
							<input id="txtSalesno2" type="text" class="num" style="width:70px;"/>
							<select id="combSalesno2" class="txt" style="width:20px;">  </select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input id="txtAddr_home" type="text" class="txt c1"/></td>

					</tr>
					<tr>
						<td><span> </span><a id='' class="lbl">營登地址</a></td>
						<td colspan="5">
					...
					<tr>
						<td><span> </span><a id='' class="lbl">送貨地址</a></td>
						<td colspan="5">
					...
					<tr>
						<td><span> </span><a id='' class="lbl">帳單地址</a></td>
						<td colspan="5">
					...
					<tr>
						...
						<td>
							<span> </span><a id='' class="lbl">運費計算方式</a>
						</td>
					...
					<tr>
						...
						<td colspan="3"><input id="txtBillmemo" type="text" class="txt c1"/></td>
						<td>
							<span> </span><a id='' class="lbl">帳務條件</a>
						</td>
						<td><select id="cmbCustno2" class="txt c1"> </select></td>
					</tr>
					<tr>
