			...
			<div id="mainbody">
				<table class="tsel" border="0" width="100%">
					...
					<tr>
						...
						<input class="txt" id="txtResult" type="text" style="font-size:medium;" />
						</td>
					</tr>
					<tr>
						<td colspan="3" align="center">
						<input id="btnQr" type="button" value='讀取QR Code' />
						</td>
					</tr>
				</table>
			</div>
            ...
            function gotSources(sourceInfos) {
                for (var i = 0; i != sourceInfos.length; ++i) {
                    ...
                    if (sourceInfo.kind === 'video') {
                        ...
                        //$('#txtResult').val($('#txtResult').val()+';'+option.text+','+option.value);
                    } else {
                        console.log('Some other kind of source: ', sourceInfo);
                    }
                }
                $('#videoSource').get(0).selectedIndex=$('#videoSource').length;
                load(); 
            }
