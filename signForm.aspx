...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
            <tr>
               ...
               <td class="label2" ><a id="lblTablea"></a></td>
               <td class="column2"><input id="txtTablea" type="text" class="txt c1" /></td>
               <td class="label3" ><a id="lblPart"></a></td>
               <td class="column3"><input id="txtPart" type="text" class="txt c1" /></td>
            </tr>
            <tr>
               <td class="label1" ><a id='lblChecker'></a></td>
               <td class="column1"><input id="txtChecker"  type="text" class="txt c1"/></td>
               <td class="label2" ><a id="lblApprov"></a></td>
               <td class="column2"><input id="txtApprov" type="text" class="txt c1" /></td>
               <td class="label3" ></td>
               <td class="column3"></td>
            </tr>
            <tr>
               <td class="label1" ><a id='lblApprove'></a></td>
               <td class="column1"><input id="txtApprove"  type="text" class="txt c1"/></td>
               <td class="label2" ><a id="lblApprove2"></a></td>
               <td class="column2"><input id="txtApprove2" type="text" class="txt c1" /></td>
               <td class="label3" ></td>
               <td class="column3"></td>
            </tr>
            <tr>
               <td class="label1" ><a id='lblEssential'></a></td>
               <td class="column1"colspan="5"><textarea id="txtEssential" cols="10" rows="5" style="width: 99%; height: 127px;"></textarea></td>
            </tr>
        </table>
        </div>
        </div>
