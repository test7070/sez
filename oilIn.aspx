...
<head>
    ...
    <script type="text/javascript">
        ...
        //ajaxPath = ""; //  execute in Root
		 aPop = new Array(['txtOilstationno', 'btnOilstation', 'oilstation', 'noa,station', 'txtOilstationno,txtOilstation', 'oilstation_b.aspx']);
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <div class="dview" id="dview" style="float: left;  width:25%;"  >
           <table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
            <tr>
                ...
                <td align="center" style="width:40%"><a id='vewOilstation'></a></td>
            </tr>
             <tr>
        ...
        <tr>
	     ...
	     <tr>
               <td class="label1" ><input id="btnOilstation" type="button" style="width: auto;font-size: medium;" /></td>
               <td class="column1"><input id="txtOilstationno" type="text"  class="txt c1"/></td>
               <td class="column1a"><input id="txtOilstation" type="text"  class="txt c1"/></td>
               <td class="label2" ></td>
               <td class="column2"></td>
        </tr>
         <tr>
              <td class="label1"  ><a id='lblMount'></a></td>
              <td class="column1" colspan="2"><input id="txtMount" type="text"  class="txt c1" style="text-align: right;"/></td>
              <td class="label2" ></td>
              <td class="column2"></td> 
         </tr>
	   <tr>   
		     <td class="label1" ><a id='lblWorker'></a></td>
             <td class="column1" colspan="2"><input id="txtWorker"  type="text"  class="txt c1"/></td>
	         <td class="label2" ></td>
             <td class="column2"></td>
	   </tr>        
        </table>
