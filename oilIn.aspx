    ...
    <script type="text/javascript">
      ...
      /*  function pop(form, seq) {
        ...
        function _btnSeek() {
            ...
            q_box('oilin_s.aspx', q_name + '_s', "500px", "310px", q_getMsg( "popSeek"));
        }
...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <tr>
	     ...
	     <tr>
               ...
               <td class="td2" colspan="2"><input id="txtOilstationno" type="text"  class="txt c2"/>
               <input id="txtOilstation" type="text"  class="txt c3"/></td>
               <td class="td4"></td>
               <td class="td5"></td>
        </tr>
         <tr>
              <td class="td1"><span> </span><a id='lblMount' class="lbl"></a></td>
              <td class="td2" colspan="2"><input id="txtMount" type="text"  class="txt num c1" /></td>
              <td class="td3"></td>
              <td class="td4"></td> 
         </tr>
	   <tr>   
