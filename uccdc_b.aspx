		...
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				<tr>
					...
					<th align="center" style='color:blue;' ><a id='lblVacc1'> </a></th>
					<th align="center" style='color:blue;' ><a id='lblRacc1'> </a></th>
				</tr>
				<tr>
					<td style="width:2%;">
					...
					<td style="width:20%;">
					<input class="txt" id="txtVacc2.*" type="text" style="width:98%;"  readonly="readonly" />
					</td>
					<td style="width:20%;">
					<input class="txt" id="txtRacc2.*" type="text" style="width:98%;"  readonly="readonly" />
					</td>
				</tr>
			</table>
