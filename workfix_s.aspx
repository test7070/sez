		...
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek" border="1" cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					...
					<input class="txt" id="txtStation" type="text" style="width:115px; font-size:medium;" disabled="disabled">
					</td>
				</tr>
				<tr class='seek_tr'>
					...
					<input class="txt" id="txtTgg" type="text" style="width:115px; font-size:medium;" disabled="disabled">
					</td>
				</tr>
				<tr class='seek_tr'>
				...
				<tr class='seek_tr'>
					...
					<td style="width:65%;"><input class="txt" id="txtWorkno" type="text" style="width:215px; font-size:medium;" ></td>
				</tr>
			</table>
