    ...
    <script type="text/javascript">
        ...
        function mainPost() { 
            ...
            $('#btnImport').click(function () {
		            ...
		            {
		            	t_where+="(caritemno!='306' and caritemno!='502' and caritemno!='501' and caritemno!='401' and caritemno!='001' and caritemno!='002' and caritemno!='101' and caritemno!='102' and caritemno!='105' and caritemno!='106' and caritemno!='111' and caritemno!='112' and caritemno!='201' and caritemno!='202' and caritemno!='203') or ";
		            }
		            t_where+=" 1=0) ";
        ...
        function btnOk() {
	        ...
	        function _btnSeek() {
	            if (q_cur > 0 && q_cur < 4)  // 1-3
	                return;
	            q_box('carc_s.aspx', q_name + '_s', "500px", "450px", q_getMsg( "popSeek"));
	        }
