                ...
                <div class='dbbm' style="float: left;">
                    <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
                        ...
                        <tr class="tr2">
                            ...
                            <td class="td3"><span> </span><a id="lblCarno" class="lbl btn"></a></td>
                        ...
                        <tr class="tr4">
                            ...
                            <td class="td4"><input id="txtInmount"  type="text"  class="txt c1"/></td>
                            <td class="td5"><span> </span><a id="lblInmoney" class="lbl"></a></td>
                            <td class="td6"><input id="txtInmoney"  type="text"  class="txt c1"/></td>
                            <td class="td7"><span> </span><a id="lblWeight" class="lbl"></a></td>
                            <td class="td8"><input id="txtWeight"  type="text"  class="txt c1"/></td>
                        </tr>
                        <tr class="tr5">
                            ...
                            <td class="td4"><input id="txtOutmount"  type="text"  class="txt c1"/></td>
                            <td class="td5"><span> </span><a id="lblOutmoney" class="lbl"></a></td>
                            <td class="td6"><input id="txtOutmoney"  type="text"  class="txt c1"/></td>
                            <td class="td7"></td>
                            <td class="td8"></td>
                        </tr>
                </table>
