...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <div class="dview" id="dview"   >
           ...
           <tr>
                ...
                <td align="center" style="width:15%"><a id='vewNamea'></a></td>
        ...
        <table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
          ...
          <tr class="tr2">
            ...
            <tr class="tr3">
               ...
               <td class="td4"><input id="txtCarplate"  type="text"  class="txt c1"/></td>
            </tr>
            <tr class="tr4">
               <td class="td1"><span> </span><a id='lblPosition' class="lbl"></a></td>
               <td class="td2"><input id="txtPosition"  type="text"  class="txt c1"/></td>
               <td class="td3"><span> </span><a id='lblReborn' class="lbl"></a></td>
               <td class="td4"><input id="txtReborn"  type="text"  class="txt c4"/><span> </span><a id="lblYn"></a></td>
               <td class="td5"></td>
            </tr>  
            <tr class="tr5">
