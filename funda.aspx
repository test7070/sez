	...
	<head>
		...
		<script type="text/javascript">
                ...
                $('#txtNoa').change(function(e){
					...
					if($(this).val().length>0){
						if((/^(\w+|\w+\u002D\w+)$/g).test($(this).val())){
                    		...
                    		q_gt('funda', t_where, 0, 0, 0, "checkFundano_change", r_accy);
						}else{
							Lock();
            ...
            function q_gtPost(t_name) {
                switch (t_name) {
                	case 'checkFundano_change':
                		var as = _q_appendData("funda", "", true);
                        if (as[0] != undefined){
                        	alert('已存在 '+as[0].noa+' '+as[0].namea);
                        }
                		break;
                	case 'checkFundano_btnOk':
                		var as = _q_appendData("funda", "", true);
                        if (as[0] != undefined){
                        	alert('已存在 '+as[0].noa+' '+as[0].namea);
                            Unlock();
            ...
            function btnOk() {
               Lock(); 
				...
				if(q_cur==1){
                    ...
                    q_gt('funda', t_where, 0, 0, 0, "checkFundano_btnOk", r_accy);
                }else{
                	wrServer($('#txtNoa').val());
                }
			...
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width:280px; color:black;"><a id='vewNamea'> </a></td>
					</tr>
					<tr>
