		...
		<script type="text/javascript">
            ...
            function pay_tre() {
                if (q_cur == 1 || q_cur == 2) {
                    ...
                    if (t_comp == '大昌' || t_comp == '日光' || t_comp == '東暉' || q_getPara('sys.project').toUpperCase() == 'VA') {
            ...
            function checkGqb_bbs(n) {
                if (n < 0) {
                    ...
                    if ($.trim($('#txtCheckno_' + n).val()).length > 0 && ($('#txtAcc1_' + n).val().substring(0, 4) == '2121' || $('#txtAcc2_' + n).val().indexOf('應付票據') >= 0) && q_float('txtMoney_' + n) < 0) {
                        //開退  ,2121 , 金額負
                        checkGqb_bbs(n - 1);
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr class="tr3">
						...
						<td class="td2" colspan='3'><input id="txtTggno2" type="text" class="txt c1"/></td>
						...
						<td> </td>
						<td><input id="btnExplain" type="button" style="display:none;" /></td>
					</tr>
					<tr class="tr4">
					...
					<tr class="tr6">
						...
						<td align="right">
							<span> </span><a id='lblRc2no' class="lbl" style="width: 80%;"> </a>
						...
						<td align="right">
							<a id='lblWorker' class="lbl " style="width:80%;"> </a>
							<a id='lblWorker2' class="lbl "style="width:80%;"> </a></td>
						<td>
