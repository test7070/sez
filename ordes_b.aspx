<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    var q_name = 'ordes', t_bbsTag = 'tbbs', t_content = " field=datea,productno,product,spec,dime,width,lengthb,unit,mount,weight,notv,noa,no2,price,theory,datea,custno,style,class,uno,total,memo,comp,cuamount,ucahours,stationhours,stationgen", afilter = [], bbsKey = ['noa'],  as; //, t_where = '';
