<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    var q_name = 'ordes', t_bbsTag = 'tbbs', t_content = " field=datea,productno,product,spec,dime,width,lengthb,unit,mount,weight,notv,noa,no2,price,theory,datea,custno,style,class,uno,total,comp,cuamount", afilter = [], bbsKey = ['noa'],  as; //, t_where = '';
        ...
        <table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
            ...
            <tr  style='background:#cad3ff;'>
               ...
               <!-- <td style="width:8%;"><input class="txt" id="txtWeight.*" type="text" style="width:96%; text-align:right;"/></td>
                ...
                <td><input class="txt" id="txtMemo.*" type="text" style="width:98%;"/><input id="recno.*" type="hidden" /><input id="txtTotal.*" type="hidden" /><input id="txtDatea.*" type="hidden" /></td>
            </tr>
        </table>
