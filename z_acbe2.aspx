		...
		<script type="text/javascript">
		    $(document).ready(function () {
		        ...
		        $('#btnOk').click(function () {
		            ...
		            var t_para = "r_comp=" + q_getPara('sys.comp') + ",r_accy=" + r_accy + ",r_cno=" + r_cno + ",year1=" + t_byear + ",bmon1=" + t_bmon1 + ",bmon2=" + t_bmon2 + ",part1=" + t_part1 + ",proj1=" + t_proj1 + ",year2=" + t_eyear + ",emon1=" + t_emon1 + ",emon2=" + t_emon2 + ",part2=" + t_part2 + ",proj2=" + t_proj2;
