...
var q_readonlys= [];
var bbmNum = [['txtTotalus', 10, 4, 1],['txtPrice', 10, 3, 1],['txtTranmoney', 10, 0, 1],['txtMoney', 10, 0, 1],['txtTotal', 10, 0, 1],['txtWeight', 10, 0, 1]];
...
return;
ret = q_gridAddRow(bbsHtm, 'tbbs', 'txtProductno,txtProduct,txtSpec,txtSize,txtDime,txtWidth,txtLengthb,txtUnit,txtOrdeno,txtNo2,txtPrice,txtStyle,txtClass,txtUno,txtMount', b_ret.length, b_ret
, 'productno,product,spec,size,dime,width,lengthb,unit,noa,no2,price,style,class,uno,mount'
			...
			<div class="dbbm">
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td colspan="2">
							<input id="txtPaytype" type="text" style="float:left;width:50%;"/>
							<select id="combPaytype" style="float:left;width:50%;" onchange='combPaytype_chg()'> </select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input id="btnImportVcce" type="button" /> </td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2">
							...
							<select id="cmbTaxtype" class="txt" style="width:40%;" onchange="calTax()"> </select>
						</td>
					</tr>
					<tr>
		...
		<div class='dbbs'>
			<table id="tbbs" class='tbbs' style=' text-align:center'>
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:120px;"><a id='lblStyle_st'> </a></td>
					...
					<td align="center" style="width:80px;"><a id='lblUsecoil_st'> </a></td>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td><input type="text" id="txtStyle.*" style="width:95%;" /></td>
					<td><input type="text" id="txtProduct.*" style="width:95%;" /></td>
					<!--<td><input class="txt c1" id="txtSpec.*" type="text"/></td>-->
					<td>
					<input class="txt num" id="textSize1.*" type="text" style="float: left;width:30%;" disabled="disabled"/>
					<div id="x1.*" style="float: left" >
						x
					</div>
					<input class="txt num" id="textSize2.*" type="text" style="float: left;width:30%;"  disabled="disabled"/>
					<div id="x2.*" style="float: left">
						x
					</div>
					<input class="txt num" id="textSize3.*" type="text" style="float: left;width:30%;" disabled="disabled"/>
					<div id="x3.*" style="float: left">
						x
					</div>
					<input class="txt num" id="textSize4.*" type="text"  style="width:95%;" disabled="disabled"/>
					<!--上為虛擬下為實際-->
					...
					<td>
					<input id="txtMount.*" type="text" class="txt num c1" style="width:95%;"/>
					</td>
					<td>
					<input id="txtWeight.*" type="text" class="txt num c1" style="width:95%;"/>
					</td>
					<td>
					<input id="txtPrice.*" type="text"  class="txt num c1" style="width:95%;"/>
					</td>
					<td>
					<input id="txtTotal.*" type="text" class="txt num c1" style="width:95%;"/>
					<input id="txtTheory.*" type="text" class="txt num c1" style="width:95%;"/>
					</td>
					<td>
					<input id="txtGweight.*" type="text"  class="txt num c1" style="width:95%;"/>
					</td>
					<td >
					<input class="txt c7" id="txtUsecoil.*" style="text-align:center;" type="text" style="width:95%;"/>
					</td>
					<td >
					<input class="btn"  id="btnStoreno2.*" type="button" value='.' style=" font-weight: bold;width:1%;float:left;" />
					<input  id="txtStoreno2.*" type="text" style="width:75%;" />
					<input id="txtStore2.*" type="text" style='width: 83%;'/>
					</td>
					<td>
					<input id="txtMemo.*" type="text" class="txt c1" style="width:95%;"/>
