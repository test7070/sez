...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			aPop = new Array(
				['txtCustno', 'lblCust', 'cust', 'noa,comp,nick,tel,fax,zip_comp,addr_comp,paytype,trantype,salesno,sales,custno2,cust2', 'txtCustno,txtComp,txtNick,txtTel,txtFax,txtPost,txtAddr,txtSalesno,txtSales,txtCustno2,txtComp2', 'cust_b.aspx'],
			...
			<div class='dbbm' style="width: 882px;">
				<table class="tbbm" id="tbbm" style="width: 882px;">
					...
					<tr>
						...
						<td class="td3"><span> </span><a id="lblMemo2" class="lbl"> </a></td>
						<td class="td4" colspan='4'><textarea id="txtMemo2" cols="10" rows="5" style="width: 50%;height: 50px;"> </textarea></td>
					</tr>
				</table>
			</div>
			<div class="tbbm" id="tbbm">
				<table border="0">
					<tr>
					...
					<tr>
						<td><a id="lblMoney" class="lbl"> </a></td>
						<td><input id="txtMoney" type="text" class="txt num c1"/></td
					</tr>
					<tr>
						<td><a id='lblTax' class="lbl"> </a></td>
						<td>
