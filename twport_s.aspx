	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {
		        ...
		        if (t_carno.length>0)
		       		t_where += " and exists(select noa from twports where twports.noa=twport.noa and twports.carno='"+t_carno+"')";
		        if (t_driverno.length>0)
		       		t_where += " and exists(select noa from twports where twports.noa=twport.noa and twports.driverno='"+t_driverno+"')";
		        if (t_caseno.length>0)
		       		t_where += " and exists(select noa from twports where twports.noa=twport.noa and twports.caseno='"+t_caseno+"')";
