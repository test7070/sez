		...
		<script type="text/javascript">
				...
				$('#txtNoa').change(function(e) {
					...
					if ($(this).val().length > 0) {
						if ((/^(\w+|\w+\u002D\w+)$/g).test($(this).val())) {
							...
							q_gt('custtype', t_where, 0, 0, 0, "checkCusttypeno_change", r_accy);
						} else {
							Lock();
			...
			function btnOk() {
				...
				if (q_cur == 1) {
					...
					q_gt('custtype', t_where, 0, 0, 0, "checkCusttypeno_btnOk", r_accy);
				} else {
					wrServer($('#txtNoa').val());
				}
			}
