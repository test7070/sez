	...
	<head>
		...
		<script type="text/javascript">
            ...
            aPop = new Array(['txtCustno', '', 'cust', 'noa,nick', 'txtCustno,txtCust', 'cust_b.aspx'],
            							['txtGrpno', 'lblGrpno', 'cust', 'noa,nick', 'txtGrpno,txtGrp', 'cust_b.aspx']
            );
            ...
            function q_gfPost() {
                ...
                q_mask(bbmMask);
				$('#txtNoa').focus();
                q_cmbParse("cmbStyle", "@全部,"+q_getPara('adsss.stype'));
                
                $('#txtCust').attr('readonly', true).css('background-color', 'rgb(237,237,238)').css('color', 'green');
                $('#txtGrp').attr('readonly', true).css('background-color', 'rgb(237,237,238)').css('color', 'green');
            }
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                t_grpno = $.trim($('#txtGrpno').val());
                t_style = $.trim($('#cmbStyle').val());
		...
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					...
					<td>
						<input class="txt" id="txtGrpno" type="text" style="width:90px; font-size:medium;" />
						<input class="txt" id="txtGrp" type="text" style="width:115px;font-size:medium;" />
					</td>
				</tr>
				<tr class='seek_tr'>
					<td style="width:35%;" ><a id='lblStyle'> </a></td>
					<td style="width:65%;"> <select id="cmbStyle"> </select></td>
				</tr>
			</table>
