                ...
                switch (b_pop) {
                    ...
                    case 'orde':
                        if (q_cur > 0 && q_cur < 4) {
                            ...
                            ret = q_gridAddRow(bbsHtm, 'tbbs', 'txtOrdeno,txtNo2,txtProductno,txtClass,txtStyle,txtProduct,txtRadius,txtDime,txtWidth,txtLengthb,txtSpec,txtWeight,txtMount,txtPrice', b_ret.length, b_ret,
                            												'noa,no2,productno,class,style,product,radius,dime,width,lengthb,spec,weight,mount,price', 'txtProductno');
                            /// 最後 aEmpField 不可以有【數字欄位】
                        }
                        sum();
                        break;
