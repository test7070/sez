		...
		<div class='dbbs' style="display: none;">
			<table id="tbbs" class='tbbs'>
				...
				<tr style='background:#cad3ff;'>
					...
					<td>
						<input class="btn" id="btnStationno.*" type="button" value='.' style=" font-weight: bold;width:1%;float:left;" />
						<input id="txtStationno.*" type="text" style="width: 85%;"/>
					</td>
					<td><input type="text" id="txtStation.*" style="width:85%; float:left;"/></td>
