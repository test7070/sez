...
<!--#include file="../inc/toolbar.inc"-->
    <div id='dmain' >
        ...
        <tr class="tr2">
            ...
            <td class="td6"><span> </span><a id="lblCuseno" class="lbl"> </a></td>
            <td class="td7"><input id="txtCuseno"  type="text" class="txt c1"/> </td>
            <td class="td8"><input id="txtCuseno2"  type="text" class="txt c1"/> </td>
        </tr>
        <tr class="tr3">
