<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			var q_name = 'fixucc', t_content = ' ', bbsKey = ['noa'], as;
			var isBott = false;
		...
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				<tr>
					...
					<th align="center" style='color:blue;' ><a id='lblInprice'> </a></th>
				</tr>
				<tr>
					<td style="width:2%;">
					...
					<td style="width:20%;">
					<input class="txt" id="txtInprice.*" type="text" style="width:98%; text-align: right;"  readonly="readonly" />
					</td>
