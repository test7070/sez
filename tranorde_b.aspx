...
<script type="text/javascript">
    ...
    function bbsSave(as) {
        if (!as['datea2']) {  // Dont Save Condition
...
//        }
    ...
    function q_gtPost(t_postname) {  /// ???U??? ...
...
<div  id="dbbs"  >
        <table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style="width: 100%;" >
            <tr style='color:White; background:#003366;' >
                ...
                <td align="center" class="td1"><a id='lblDatea2_s'> </a></td>
                <td align="center" class="td1"><a id='lblWeight2_s'> </a></td>
                <td align="center" class="td1"><a id='lblTrannumber_s'> </a></td>
                <!--<td align="center" ><a id='lblMemo'></a></td>-->
            </tr>
            <tr  style='background:#cad3ff;'>
                <td style="width:1%;"><input class="btn"  id="btnMinus.*" type="button" value='-' style="font-weight: bold; "  /></td>
                <td ><input class="txt c1"  id="txtDatea2.*" type="text" /><input class="txt c1" id="txtNoq.*" type="hidden" /><input id="txtNoa.*" type="hidden" /></td>
                <td ><input class="txt c1" id="txtWeight2.*" type="text" /></td>
                <td ><input class="txt c1" id="txtTrannumber.*" type="text" /></td>
