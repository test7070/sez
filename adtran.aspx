	...
	<head>
		...
		<script type="text/javascript">
			...
			function _btnSeek() {
				if (q_cur > 0 && q_cur < 4)
					return;
				q_box('adtran_s.aspx', q_name + '_s', "500px", "400px", q_getMsg("popSeek"));
			}
			...
			function btnPrint() {
				q_box('z_adtran.aspx' + "?;;;;" + r_accy + ";", '', "95%", "95%", m_print);
			}
			...
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width:120px; color:black;"><a id='vewMon'> </a></td>
						<td align="center" style="width:120px; color:black;"><a id='vewStyle'> </a></td>
						<td align="center" style="width:280px; color:black;"><a id='vewPost'> </a></td>
						<td align="center" style="width:280px; color:black;"><a id='vewTrantype'> </a></td>
