...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
			...
			var bbmNum = [
				['txtMount', 10, 0, 1], ['txtSale_money', 14, 0, 1], ['txtBuy_money', 14, 0, 1],
				['txtDepl', 14, 0, 1], ['txtAccumulat', 14, 0, 1], ['txtC4', 14, 0, 1],
				['txtC5', 14, 0, 1]
			];
			var bbmMask = [];
			q_sqlCount = 6;
			...
			function q_gtPost(t_name) {
				switch (t_name) {
					case 'view_acczt':
						var as = _q_appendData("view_acczt", "", true);
						Before_Depl = 0;
						//前期折舊
						This_Depl = 0;
						//本期折舊
					...
					case 'accz':
						...
						SetZero();
						if (as[0] != undefined) {
							canSaleMount = dec(as[0].mount);
							acczMoney = dec(as[0].money);
							accumulat = dec(as[0].accumulat);
						}
						Unlock();
						$('#txtComp').focus();
					case q_name:
