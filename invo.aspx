		...
		<script type="text/javascript">
			...
			function q_stPost() {
				if (!(q_cur == 1 || q_cur == 2))
					return false;
				if(q_cur != 2)
					q_func('qtxt.query.u2', 'invo.txt,post,' + encodeURI($('#txtNoa').val()) + ';1;'+q_getPara('sys.key_vcc')+';'+q_getPara('vcc.pricePrecision')+';'+r_userno+';'+r_name+';'+q_getPara('sys.dateformat'));//新增,修改
			}
			...
			function btnDele() {
				...
				if (!confirm(mess_dele))
					return;
				q_cur = 3;
				q_func('qtxt.query.u3', 'invo.txt,post,' + encodeURI($('#txtNoa').val()) + ';0;'+q_getPara('sys.key_vcc')+';'+q_getPara('vcc.pricePrecision')+';'+r_userno+';'+r_name+';'+q_getPara('sys.dateformat'));//刪除
			}
		...
		<div class='dbbm'>
			<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing=''>
				<tr class="tr0" style="height: 0px;">
					...
					<td class="td3" style="width:150px;"> </td>
					<td class="td4" style="width:150px;"> </td>
		       ...
		       <tr class="tr7">
				...
				<tr class="tr8">
					...
					<td class="td5"><input id="btnPack" type="button"/> </td>
					<td class="td6">
