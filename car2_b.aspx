		...
		<script type="text/javascript">
            ...
            function main() {
                ...
                $('#btnSearch').click(function() {
                    var t_where = "1=1";
                    if ($.trim($('#txtCarno').val()).length>0) {
                        t_where += " and charindex('" + $('#txtCarno').val() + "',a.noa)>0";
                    }
                    if ($.trim($('#txtDriver').val()).length>0) {
                        t_where += " and (charindex('" + $('#txtDriver').val() + "',a.driverno)>0 or charindex('" + $('#txtDriver').val() + "',f.namea)>0)";
                    }
		...
		<div id="dbbs" >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:95%;' >
				<tr>
					...
					<th align="center" style='color:blue;'><a id='lblDriverno'> </a></th>
				...
				<tr>
					...
					<td style="width:30%;">
					<input class="txt" id="txtDriverno.*" type="text" style="width:95%;"  readonly="readonly" />
					</td>
					<td style="width:30%;">
					<input class="txt" id="txtDriver.*" type="text" style="width:95%;"  readonly="readonly" />
					</td>
				</tr>
			</table>
			<div>
				<a>車牌</a>
				<input class="txt" id="txtCarno" type="text" style="width:130px;" />
				<a>司機</a>
				<input class="txt" id="txtDriver" type="text" style="width:130px;" />
