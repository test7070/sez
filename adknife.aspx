	...
	<head>
		...
		<script type="text/javascript">
			...
			function mainPost() {
				...
				q_mask(bbmMask);
				bbmNum = [['txtDime1', 10, 3, 1],['txtDime2', 10, 3, 1],['txtWidth1', 10, 3, 1],	['txtWidth2', 10, 3, 1],
									['txtKnife1', 10, 3, 1],['txtKnife2', 10, 3, 1],	['txtPrice', 10, q_getPara('vcc.pricePrecision'), 1]];
			...
			function _btnSeek() {
				if (q_cur > 0 && q_cur < 4)
					return;
				q_box('adknife_s.aspx', q_name + '_s', "500px", "400px", q_getMsg("popSeek"));
			}
			...
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width:100px; color:black;"><a id='vewKnife1'> </a></td>
						<td align="center" style="width:100px; color:black;"><a id='vewKnife2'> </a></td>
					...
					<tr>
						...
						<td id='knife1' style="text-align: right;">~knife1</td>
						<td id='knife2' style="text-align: right;">~knife2</td>
