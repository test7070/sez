...
<!--#include file="../inc/toolbar.inc"-->
        ...
        <tr>
            ...
            <td class="column1"><input id="txtNoa"  type="text" style='width:98%;'/></td>
            <td class='label2'></td>
            <td class="column2"></td>
        </tr>
        <tr>            
            <td class='label1'><input id="btnTgg" type="button"/></td>
            <td class="column1"><input id="txtTggno"type="text" style='width:30%;'/><input id="txtTgg"type="text" style='width:60%;'/></td>
            <td class='label2'><input id="btnBcc" type="button" /></td>
            <td class="column2"><input id="txtBccno" type="text"  style='width:30%;'/><input  id="txtBccname" type="text"  style='width:60%;'/></td>            
            <td class='label3'></td>
            <td class="column3"></td>
        </tr>    
        <tr>
            <td class='label1'><a id="lblMemo" ></a></td>
            <td class="column1" colspan="4"><textarea id="txtMemo" cols="10" rows="5" style="width: 98%;" /></textarea></td>
        </tr>    
        </table>
        </div>
        ...
        <table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
            ...
            <tr  style='background:#cad3ff;'>
                ...
                <td ><input class="txt" id="txtDatea.*"type="text" /></td>
                <td ><input class="txt" id="txtPrice.*" type="text"/></td>
                <td ><input class="txt" id="txtUnit.*" type="text" /></td>
                <td ><input class="txt" id="txtMemo.*" type="text" /></td>
                <td ><input class="txt" id="txtSprice.*"type="text" /></td>
                <td ><input class="txt" id="txtOdate.*" type="text" /></td>
                <td ><input class="txt" id="txtChkname.*" type="text" /></td>
