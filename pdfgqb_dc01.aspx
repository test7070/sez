	...
	order  by  gqbno,gno;";
            ...
            else
            {
                for (int i = 0; i < gqbLabel.Count; i++)
                {
                    ...
                    cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, ((Para)gqbLabel[i]).a01, 54 + shiftX, 155 + shiftY, 0);
                    cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, ((Para)gqbLabel[i]).a02, 54 + shiftX, 130 + shiftY, 0);
                    cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, ((Para)gqbLabel[i]).a03, 54 + shiftX, 60 + shiftY, 0);
                    cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, ((Para)gqbLabel[i]).a04, 54 + shiftX, 42 + shiftY, 0);

                    cb.SetFontAndSize(bfChinese, 9);
                    cb.ShowTextAligned(iTextSharp.text.pdf.PdfContentByte.ALIGN_LEFT, ((Para)gqbLabel[i]).b01, 455 + shiftX, 208 + shiftY, 0);
