	   ...
	   function main() {
			...
			$('#txtNoa').change(function(e){
				...
				if($(this).val().length>0){
					...
					t_where="where=^^ noa='"+$(this).val()+"'^^";
				   	q_gt('modg', t_where, 0, 0, 0, "checkNoa_change", r_accy);
				}
			});
		}
		...
		function q_gtPost(t_name) {  
			switch (t_name) {
 				case 'checkNoa_change':
					var as = _q_appendData("modg", "", true);
					if (as[0] != undefined){
		...
		function btnOk() {
			...
			if(q_cur==1){
				...
				q_gt('modg', t_where, 0, 0, 0, "checkNoa_btnOk", r_accy);
			}else{
				wrServer($('#txtNoa').val());
			}
		 }
		...
		<div class="dview" id="dview" style="float: left;"  >
		   <table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
			<tr>
				...
				<td align="center" style="width:56%"><a id='vewNamea'> </a></td>								
			</tr>
			 <tr>
