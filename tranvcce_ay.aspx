...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            var q_readonlys = [];
            var bbmNum = [];
            var bbsNum = [['txtMount', 10, 2, 1],['txtWeight', 10, 0, 1],['txtVolume', 10, 0, 1]];
            var bbmMask = [];
            ...
            function mainPost() {
                ...
                q_mask(bbmMask);
                $('#txtDatea').datepicker();
                q_cmbParse("cmbCarno",',北部,中部,南部,回頭車');
                q_cmbParse("cmbTypea",'收件,送件','s');
            ...
            function bbsSave(as) {
                ...
                as['cust'] = abbm2['addr'];
                as['calctype'] = abbm2['carno'];
                as['bdate'] = abbm2['datea'];
                return true;n
            }
		...
		<div id="dmain" >
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width:20%"><a>地區</a></td>
					</tr>
					<tr>
						<td>
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
                    ...
                    <tr>
                        <td><span> </span><a id="lblCarno_ay" class="lbl" >地區</a></td>
                        <td><select id="cmbCarno" class="txt c1"> </select></td>
                    </tr>
                    <tr>
                        <td><span> </span><a id="lblLat" class="lbl" >聯絡人</a></td>
                        <td><input id="txtLat" type="text" class="txt c1" /></td>
                        <td><span> </span><a id="lblLng" class="lbl" >電話</a></td>
                        <td><input id="txtLng" type="text" class="txt c1" /></td>
                    </tr>
                    <tr>
                        <td><span> </span><a id="lblAddress" class="lbl" >地址</a></td>
		...
		<div class='dbbs' >
			<table id="tbbs" class='tbbs' >
				<tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:60px"><a>類別</a></td>
					<td align="center" style="width:100px"><a>指定時間</a></td>
					<td align="center" style="width:100px"><a>收貨點</a></td>
                    <td align="center" style="width:100px"><a>交貨點</a></td>
					...
					<td align="center" style="width:20px"><a>結案</a></td>
